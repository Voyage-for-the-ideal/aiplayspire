...
public class CreatureState {
    ...
    public CreatureState(String jsonString) {
        ...
        this.drawX = parsed.get("draw_x").getAsFloat();
        this.drawY = parsed.get("draw_y").getAsFloat();
        this.dialogX = parsed.get("dialog_x").getAsFloat();
        this.dialogY = parsed.get("dialog_y").getAsFloat();
        ...
        this.escapeTimer = parsed.get("escape_timer").getAsFloat();
        this.isEscaping = parsed.get("is_escaping").getAsBoolean();
        this.lastDamageTaken = parsed.get("last_damage_taken").getAsInt();
        this.hb_x = parsed.get("hb_x").getAsFloat();
        this.hb_y = parsed.get("hb_y").getAsFloat();
        this.hb_w = parsed.get("hb_w").getAsFloat();
        this.hb_h = parsed.get("hb_h").getAsFloat();
        ...
        this.hbAlpha = parsed.get("hb_alpha").getAsFloat();
        this.animX = parsed.get("anim_x").getAsFloat();
        this.animY = parsed.get("anim_y").getAsFloat();
        this.reticleAlpha = parsed.get("reticle_alpha").getAsFloat();
    ...
    public CreatureState(JsonObject creatureJson) {
        ...
        this.drawX = creatureJson.get("draw_x").getAsFloat();
        this.drawY = creatureJson.get("draw_y").getAsFloat();
        this.dialogX = creatureJson.get("dialog_x").getAsFloat();
        this.dialogY = creatureJson.get("dialog_y").getAsFloat();
        ...
        this.escapeTimer = creatureJson.get("escape_timer").getAsFloat();
        ...
        this.hb_x = creatureJson.get("hb_x").getAsFloat();
        this.hb_y = creatureJson.get("hb_y").getAsFloat();
        this.hb_w = creatureJson.get("hb_w").getAsFloat();
        this.hb_h = creatureJson.get("hb_h").getAsFloat();
        ...
        this.hbAlpha = creatureJson.get("hb_alpha").getAsFloat();
        this.animX = creatureJson.get("anim_x").getAsFloat();
        this.animY = creatureJson.get("anim_y").getAsFloat();
        this.reticleAlpha = creatureJson.get("reticle_alpha").getAsFloat();
