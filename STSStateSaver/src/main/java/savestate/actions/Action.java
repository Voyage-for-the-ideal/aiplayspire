...
public enum Action {
    ...
    EMPTY_DECK_SHUFFLE_ACTION(EmptyDeckShuffleAction.class, action -> new EmptyDeckShuffleActionState(action)),
    ...
    NEW_QUEUE_CARD_ACTION(NewQueueCardAction.class, action -> new NewQueueCardActionState(action)),
    ...
    SHUFFLE_ACTION(ShuffleAction.class, action -> new ShuffleActionState(action)),
