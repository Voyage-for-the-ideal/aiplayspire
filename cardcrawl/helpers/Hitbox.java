...
public class Hitbox {
    ...
    public float width;
    public float height;
    public boolean hovered = false, justHovered = false, clickStarted = false, clicked = false;
    ...
    public void update(float x, float y) {
        ...
        if (!this.hovered) {
            this.hovered = (InputHelper.mX > x && InputHelper.mX < x + this.width && InputHelper.mY > y
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\helpers\Hitbox.
