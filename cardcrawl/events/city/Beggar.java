...
public class Beggar extends AbstractImageEvent {
    ...
    public Beggar() {
        ...
        if (AbstractDungeon.player.gold >= 75) {
            this.imageEventText.setDialogOption(OPTIONS[0] + 'K' + OPTIONS[1], (AbstractDungeon.player.gold < 75));
        } else {

            this.imageEventText.setDialogOption(OPTIONS[2] + 'K' + OPTIONS[3], (AbstractDungeon.player.gold < 75));
        }
    ...
    public void update() {
        ...
        if (!AbstractDungeon.isScreenUp && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
            ...
            logMetricCardRemovalAtCost("Beggar", "Gave Gold", AbstractDungeon.gridSelectScreen.selectedCards
        ...
        switch (this.screen) {
            ...
            case GAVE_MONEY:
                AbstractDungeon.gridSelectScreen.open(
                        ...
                        OPTIONS[6], false, false, false, true);
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\events\city\Beggar
