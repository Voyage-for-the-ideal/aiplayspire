...
public class WeMeetAgain
    ...
    public WeMeetAgain() {
        ...
        if (this.potionOption != null) {
            this.imageEventText
                    .setDialogOption(OPTIONS[0] + FontHelper.colorString(this.potionOption.name, "r") + OPTIONS[6]);
        } else {
        ...
        if (this.cardOption != null) {
            this.imageEventText.setDialogOption(OPTIONS[4] + this.cardOption.name + OPTIONS[6], this.cardOption
                ...
                switch (buttonPressed) {
                    ...
                    case 2:
                        ...
                        AbstractDungeon.topLevelEffects.add(
                                new PurgeCardEffect(this.cardOption, Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F));
 ...
 * WeMeetAgain.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
