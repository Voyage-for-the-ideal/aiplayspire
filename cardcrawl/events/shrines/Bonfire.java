...
public class Bonfire extends AbstractImageEvent {
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/events/shrines/Bonfire$CUR_SCREEN.
     * class
     */
    ...
    public void update() {
        ...
        if (this.cardSelect && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
            ...
            AbstractDungeon.topLevelEffects
                    .add(new PurgeCardEffect(this.offeredCard, Settings.WIDTH / 2, Settings.HEIGHT / 2));
            ...
            case CURSE:
                ...
                if (AbstractDungeon.player.hasRelic(SpiritPoop.ID)) {
                    ...
                    AbstractDungeon.getCurrRoom().spawnRelicAndObtain(Settings.WIDTH / 2.0f, Settings.HEIGHT / 2.0f,
                            RelicLibrary.getRelic(SpiritPoop.ID).makeCopy());
                    break;
                }
            case BASIC:
