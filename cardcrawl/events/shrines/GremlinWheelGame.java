...
public class GremlinWheelGame
    ...
    private float bounceTimer = 1.0F, animTimer = 3.0F;
    ...
    public void update() {
        ...
        if (this.bounceTimer == 0.0F && this.startSpin) {
            if (!this.buttonPressed) {
                this.buttonHb.cY = MathHelper.cardLerpSnap(this.buttonHb.cY,
                        Settings.OPTION_Y - 330.0F * Settings.scale);
    ...
    private void preApplyResult() {
        ...
        this.imageEventText.setDialogOption(
                OPTIONS[6] + (int) (AbstractDungeon.player.maxHealth * this.hpLossPercent) + OPTIONS[7]);
    ...
    private void applyResult() {
        ...
        switch (this.result) {
            ...
            case 1:
                ...
                return;
            case 2:
                logMetricHeal("Wheel of Change", "Full Heal",
            ...
            case 3:
                ...
                AbstractDungeon.effectList.add(new ShowCardAndObtainEffect((AbstractCard) decay, Settings.WIDTH / 2.0F,
            ...
            case 4:
                if (CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck.getPurgeableCards())
                    ...
                    AbstractDungeon.gridSelectScreen.open(
                            ...
                            1, OPTIONS[9], false, false, false, true);
        ...
        int damageAmount = (int) (AbstractDungeon.player.maxHealth * this.hpLossPercent);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.wheelImg, this.imgX - 512.0F, this.imgY - 512.0F, 512.0F, 512.0F, 1024.0F, 1024.0F, Settings.scale,
                Settings.scale, this.wheelAngle, 0, 0, 1024, 1024, false, false);

        sb.draw(this.arrowImg, this.imgX - 256.0F + ARROW_OFFSET_X + 180.0F * Settings.scale, this.imgY - 256.0F,
                256.0F, 256.0F, 512.0F, 512.0F, Settings.scale, Settings.scale, 0.0F, 0, 0, 512, 512, false, false);

        if (this.buttonHb.hovered) {
            sb.draw(this.buttonImg, this.buttonHb.cX - 256.0F, this.buttonHb.cY - 256.0F, 256.0F, 256.0F, 512.0F,
                    512.0F, Settings.scale * 1.05F, Settings.scale * 1.05F, 0.0F, 0, 0, 512, 512, false, false);

        } else {

            sb.draw(this.buttonImg, this.buttonHb.cX - 256.0F, this.buttonHb.cY - 256.0F, 256.0F, 256.0F, 512.0F,
                    512.0F, Settings.scale, Settings.scale, 0.0F, 0, 0, 512, 512, false, false);
        }
        ...
        if (this.buttonHb.hovered) {
            ...
            sb.setColor(new Color(1.0F, 1.0F, 1.0F,
                    (MathUtils.cosDeg((float) (System.currentTimeMillis() / 5L % 360L)) + 1.25F) / 3.5F));
        }
        if (this.buttonHb.hovered) {
            sb.draw(this.buttonImg, this.buttonHb.cX - 256.0F, this.buttonHb.cY - 256.0F, 256.0F, 256.0F, 512.0F,
                    512.0F, Settings.scale * 1.05F, Settings.scale * 1.05F, 0.0F, 0, 0, 512, 512, false, false);
        ...
        if (Settings.isControllerMode) {
            sb.draw(CInputActionSet.proceed
                    .getKeyImg(), this.buttonHb.cX - 32.0F - 160.0F * Settings.scale,
                    this.buttonHb.cY - 32.0F - 70.0F * Settings.scale, 32.0F, 32.0F, 64.0F, 64.0F, Settings.scale,
 ...
 * GremlinWheelGame.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
