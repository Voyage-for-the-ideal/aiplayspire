...
public class Sssserpent
    ...
    public Sssserpent() {
        ...
        this.curse = (AbstractCard) new Doubt();

        this.imageEventText.setDialogOption(OPTIONS[0] + this.goldReward + OPTIONS[1],
                CardLibrary.getCopy(this.curse.cardID));
        ...
        switch (this.screen) {
            ...
            case AGREE:
                AbstractDungeon.effectList
                        .add(new ShowCardAndObtainEffect(this.curse, Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F));
 ...
 * Sssserpent.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
