...
public class LivingWall extends AbstractImageEvent {
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/events/exordium/LivingWall$Choice.
     * class
     */
    private enum Choice {
        FORGET, CHANGE, GROW
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/events/exordium/LivingWall$CurScreen.
     * class
     */
        ...
        if (this.pickCard && !AbstractDungeon.isScreenUp && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
            switch (this.choice) {
                case FORGET:
                    ...
                    AbstractEvent.logMetricCardRemoval(ID, "Forget",
                    ...
                    case 1:
                        ...
                        if (CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck.getPurgeableCards())
                            ...
                            AbstractDungeon.gridSelectScreen.open(
                                    CardGroup.getGroupWithoutBottledCards(
                                            AbstractDungeon.player.masterDeck.getPurgeableCards()),
                                    1, OPTIONS[4], false, true, false, false);
                            break;
                        }
                        break;
                    default:
                        ...
                        if (CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck.getPurgeableCards())
                                .size() > 0) {
                            AbstractDungeon.gridSelectScreen.open(
                                    AbstractDungeon.player.masterDeck.getUpgradableCards(), 1, OPTIONS[5], true, false,
                                    false, false);
                            break;
                        }
                        break;
