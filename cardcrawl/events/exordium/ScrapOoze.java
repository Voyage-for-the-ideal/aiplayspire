                ...
                switch (buttonPressed) {
                    case 0:
                        ...
                        if (random >= 99 - this.relicObtainChance) {
                            ...
                            AbstractEvent.logMetricObtainRelicAndDamage("Scrap Ooze", "Success", r,
                        ...
                        this.imageEventText.updateDialogOption(0,
                                OPTIONS[4] + this.dmg + OPTIONS[1] + this.relicObtainChance + OPTIONS[2]);
 ...
 * ScrapOoze.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
