...
public class DoorUnlockScreen {
    ...
    public void open(boolean eventVersion) {
        ...
        this
                ...
                .lockRed = new DoorLock(DoorLock.LockColor.RED,
                        CardCrawlGame.playerPref.getBoolean(AbstractPlayer.PlayerClass.IRONCLAD.name() + "_WIN", false),
                        eventVersion);

        this

                .lockGreen = new DoorLock(DoorLock.LockColor.GREEN, CardCrawlGame.playerPref
                        .getBoolean(AbstractPlayer.PlayerClass.THE_SILENT.name() + "_WIN", false), eventVersion);

        this

                .lockBlue = new DoorLock(DoorLock.LockColor.BLUE,
    ...
    private void updateFadeInput() {
        ...
        if (!this.animateCircle && this.fadeTimer == 0.0F) {
            if (this.circleTimer == 0.0F) {
                ...
                } else if (InputHelper.justClickedLeft || CInputActionSet.proceed.isJustPressed()
    ...
    private void updateCircle() {
        if (this.animateCircle && this.fadeTimer == 0.0F && this.lightUpTimer == 0.0F) {
            if (this.rotatingCircle) {
                ...
                this.doorOffset = 1200.0F * Settings.scale
                        * Interpolation.pow3.apply(1.0F, 0.0F, this.circleTimer / this.doorTime);
            }
        }
    }
    ...
    private void renderMainDoor(SpriteBatch sb) {
        ...
        sb.draw(doorLeft, Settings.WIDTH / 2.0F - 960.0F - this.doorOffset, Settings.HEIGHT / 2.0F - 600.0F + yOffset,
                960.0F, 600.0F, 1920.0F, 1200.0F, this.renderScale, this.renderScale, 0.0F, 0, 0, 1920, 1200, false,
                false);

        sb.draw(doorRight, Settings.WIDTH / 2.0F - 960.0F + this.doorOffset, Settings.HEIGHT / 2.0F - 600.0F + yOffset,
                960.0F, 600.0F, 1920.0F, 1200.0F, this.renderScale, this.renderScale, 0.0F, 0, 0, 1920, 1200, false,
                false);
    }
    ...
    private void renderCircleMechanism(SpriteBatch sb) {
        ...
        sb.draw(circleRight, Settings.WIDTH / 2.0F - 960.0F + this.doorOffset,
                Settings.HEIGHT / 2.0F - 600.0F + yOffset, 960.0F, 600.0F, 1920.0F, 1200.0F, this.renderScale,
                this.renderScale, this.circleAngle, 2, 2, 1920, 1200, false, false);

        sb.draw(circleLeft, Settings.WIDTH / 2.0F - 960.0F - this.doorOffset, Settings.HEIGHT / 2.0F - 600.0F + yOffset,
                960.0F, 600.0F, 1920.0F, 1200.0F, this.renderScale, this.renderScale, this.circleAngle, 2, 2, 1920,
                1200, false, false);
    }
}
 ...
 * DoorUnlockScreen.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
