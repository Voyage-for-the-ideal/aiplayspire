...
public class HandCardSelectScreen {
    ...
    private void updateControllerInput() {
        ...
        if (!anyHovered) {
            if (!this.hand.group.isEmpty()) {
                ...
                Gdx.input.setCursorPosition((int) this.hoveredCard.hb.cX,
                        Settings.HEIGHT - (int) this.hoveredCard.hb.cY);
            ...
            if ((CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) &&
                ...
                Gdx.input.setCursorPosition((int) ((AbstractCard) this.hand.group.get(index)).hb.cX,
                        Settings.HEIGHT - y);
            ...
            unhoverCard(this.hoveredCard);
            Gdx.input.setCursorPosition((int) ((AbstractCard) this.selectedCards.group.get(index)).hb.cX,
                    Settings.HEIGHT - y);
    ...
    private void refreshSelectedCards() {
        ...
        switch (this.selectedCards.size()) {
            ...
            case 6:
                ...
                ((AbstractCard) this.selectedCards.group.get(4)).target_x = Settings.WIDTH / 2.0F
                        + 270.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(5)).target_x = Settings.WIDTH / 2.0F
                        + 450.0F * Settings.scale;
                break;
            case 7:
                ((AbstractCard) this.selectedCards.group.get(0)).target_x = Settings.WIDTH / 2.0F
                        - 540.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(1)).target_x = Settings.WIDTH / 2.0F
                        - 360.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(2)).target_x = Settings.WIDTH / 2.0F
                        - 180.0F * Settings.scale;
                ...
                ((AbstractCard) this.selectedCards.group.get(5)).target_x = Settings.WIDTH / 2.0F
                        + 360.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(6)).target_x = Settings.WIDTH / 2.0F
                        + 540.0F * Settings.scale;
                break;
            case 8:
                ((AbstractCard) this.selectedCards.group.get(0)).target_x = Settings.WIDTH / 2.0F
                        - 630.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(1)).target_x = Settings.WIDTH / 2.0F
                        - 450.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(2)).target_x = Settings.WIDTH / 2.0F
                        - 270.0F * Settings.scale;
                ...
                ((AbstractCard) this.selectedCards.group.get(6)).target_x = Settings.WIDTH / 2.0F
                        + 450.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(7)).target_x = Settings.WIDTH / 2.0F
                        + 630.0F * Settings.scale;
                break;
            case 9:
                ((AbstractCard) this.selectedCards.group.get(0)).target_x = Settings.WIDTH / 2.0F
                        - 720.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(1)).target_x = Settings.WIDTH / 2.0F
                        - 540.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(2)).target_x = Settings.WIDTH / 2.0F
                        - 360.0F * Settings.scale;
                ...
                ((AbstractCard) this.selectedCards.group.get(7)).target_x = Settings.WIDTH / 2.0F
                        + 540.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(8)).target_x = Settings.WIDTH / 2.0F
                        + 720.0F * Settings.scale;
                break;
            case 10:
                ((AbstractCard) this.selectedCards.group.get(0)).target_x = Settings.WIDTH / 2.0F
                        - 810.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(1)).target_x = Settings.WIDTH / 2.0F
                        - 630.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(2)).target_x = Settings.WIDTH / 2.0F
                        - 450.0F * Settings.scale;
                ...
                ((AbstractCard) this.selectedCards.group.get(8)).target_x = Settings.WIDTH / 2.0F
                        + 630.0F * Settings.scale;
                ((AbstractCard) this.selectedCards.group.get(9)).target_x = Settings.WIDTH / 2.0F
                        + 810.0F * Settings.scale;
                break;
        }
    ...
    private void updateSelectedCards() {
        ...
        for (Iterator<AbstractCard> i = this.selectedCards.group.iterator(); i.hasNext();) {
            ...
            if (!this.waitThenClose && Math.abs(e.current_x - e.target_x) < MIN_HOVER_DIST && e.hb.hovered
                    && (InputHelper.justClickedLeft || CInputActionSet.select
                            .isJustPressed())) {
                InputHelper.justClickedLeft = false;
            ...
            if (this.selectedCards.group.size() == this.numCardsToSelect) {
                ...
                if (this.forUpgrade && this.selectedCards.size() == 1) {
                    if (this.upgradePreviewCard == null) {
                        this.upgradePreviewCard = ((AbstractCard) this.selectedCards.group.get(0))
    ...
    public void open(String msg, int amount, boolean anyNumber, boolean canPickZero, boolean forTransform,
            boolean forUpgrade, boolean upTo) {
        prep();
    ...
    public void render(SpriteBatch sb) {
        ...
        if (!PeekButton.isPeeking) {
            ...
            FontHelper.renderFontCentered(sb, FontHelper.buttonLabelFont, this.message, (Settings.WIDTH / 2),
                    Settings.HEIGHT - 180.0F * Settings.scale, Settings.CREAM_COLOR);
    ...
    private void renderArrows(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.UPGRADE_ARROW, x, Settings.HEIGHT / 2.0F + 120.0F * Settings.scale, 32.0F, 32.0F, 64.0F,
                64.0F, this.arrowScale1 * Settings.scale, this.arrowScale1 * Settings.scale, 0.0F, 0, 0, 64, 64, false,
                false);

        x += 64.0F * Settings.scale;
        sb.setColor(Color.WHITE);
        sb.draw(ImageMaster.UPGRADE_ARROW, x, Settings.HEIGHT / 2.0F + 120.0F * Settings.scale, 32.0F, 32.0F, 64.0F,
                64.0F, this.arrowScale2 * Settings.scale, this.arrowScale2 * Settings.scale, 0.0F, 0, 0, 64, 64, false,
                false);

        x += 64.0F * Settings.scale;

        sb.draw(ImageMaster.UPGRADE_ARROW, x, Settings.HEIGHT / 2.0F + 120.0F * Settings.scale, 32.0F, 32.0F, 64.0F,
                64.0F, this.arrowScale3 * Settings.scale, this.arrowScale3 * Settings.scale, 0.0F, 0, 0, 64, 64, false,
                false);
    ...
    private void prep() {
        ...
        if (Settings.isControllerMode)
            Gdx.input.setCursorPosition((int) ((AbstractCard) this.hand.group.get(0)).hb.cX,
                    (int) ((AbstractCard) this.hand.group.get(0)).hb.cY);
    }
}
 ...
 * HandCardSelectScreen.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
