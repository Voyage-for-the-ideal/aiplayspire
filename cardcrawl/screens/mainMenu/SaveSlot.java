...
public class SaveSlot {
    ...
    public SaveSlot(int slot) {
        if (slot == CardCrawlGame.saveSlot && !CardCrawlGame.playerName.equals(CardCrawlGame.saveSlotPref
                .getString(SaveHelper.slotName("PROFILE_NAME", slot), ""))) {
        ...
        this.slotHb.move(Settings.WIDTH / 2.0F,
                Settings.HEIGHT / 2.0F + 280.0F * Settings.scale - this.index * 280.0F * Settings.scale);
    ...
    private void migration(int slot) {
        ...
        CardCrawlGame.saveSlotPref.putFloat(
                SaveHelper.slotName("COMPLETION", slot),
    ...
    private void renderText(SpriteBatch sb) {
        ...
        if (!this.emptySlot) {
            FontHelper.renderFontLeft(sb, FontHelper.buttonLabelFont, this.name, 740.0F * Settings.xScale,
                    this.slotHb.cY + 26.0F * Settings.scale, c);

            FontHelper.renderFontLeft(sb, FontHelper.charDescFont, TEXT[0] +

                    CharStat.formatHMSM((int) this.playtime), 740.0F * Settings.xScale,
                    this.slotHb.cY - 24.0F * Settings.scale, uiColor);

            if (this.completionPercentage == 100.0F) {
                FontHelper.renderFontCentered(sb, FontHelper.charTitleFont, "100%", 1200.0F * Settings.xScale,
                        this.slotHb.cY + 0.0F * Settings.scale, c);

            } else if (this.completionPercentage == 0.0F) {
                FontHelper.renderFontCentered(sb, FontHelper.charTitleFont, "0%", 1200.0F * Settings.xScale,
                        this.slotHb.cY + 0.0F * Settings.scale, c);

            } else {

                FontHelper.renderFontCentered(sb, FontHelper.charTitleFont,

                        String.format("%.1f", new Object[] {Float.valueOf(this.completionPercentage) }) + "%",
                        1200.0F * Settings.xScale, this.slotHb.cY + 0.0F * Settings.scale, c);
            }

        } else {

            FontHelper.renderFontCentered(sb, FontHelper.buttonLabelFont, TEXT[1], Settings.WIDTH / 2.0F,
                    this.slotHb.cY, c);
        }
    }

    private void renderSlotImage(SpriteBatch sb) {
        float scale = (Settings.xScale > Settings.yScale) ? Settings.xScale : Settings.yScale;

        if (this.slotHb.hovered) {
            scale *= 1.02F;
        }

        sb.draw(ImageMaster.PROFILE_SLOT, this.slotHb.cX - 400.0F, this.slotHb.cY - 130.0F, 400.0F, 130.0F, 800.0F,
                260.0F, scale, scale * 0.9F, 0.0F, 0, 0, 800, 260, false, false);

        sb.draw(this.iconImg, this.slotHb.cX - 290.0F * Settings.xScale - 50.0F, this.slotHb.cY - 50.0F, 50.0F, 50.0F,
                100.0F, 100.0F, Settings.scale, Settings.scale, 0.0F, 0, 0, 100, 100, false, false);
    ...
    private void renderDeleteIcon(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.PROFILE_DELETE, this.deleteHb.cX - 50.0F, this.deleteHb.cY - 50.0F, 50.0F, 50.0F, 100.0F,
                100.0F, scale, scale, 0.0F, 0, 0, 100, 100, false, false);

        if (this.deleteHb.hovered) {
            sb.setColor(new Color(1.0F, 1.0F, 1.0F, 0.4F));
            sb.setBlendFunction(770, 1);
            sb.draw(ImageMaster.PROFILE_DELETE, this.deleteHb.cX - 50.0F, this.deleteHb.cY - 50.0F, 50.0F, 50.0F,
                    100.0F, 100.0F, scale, scale, 0.0F, 0, 0, 100, 100, false, false);
        ...
        if (this.slotHb.hovered && Settings.isControllerMode) {
            sb.draw(CInputActionSet.topPanel
                    .getKeyImg(), this.deleteHb.cX - 32.0F + 82.0F * Settings.scale, this.deleteHb.cY - 32.0F, 32.0F,
    ...
    private void renderRenameIcon(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.PROFILE_RENAME, this.renameHb.cX - 50.0F, this.renameHb.cY - 50.0F, 50.0F, 50.0F, 100.0F,
                100.0F, scale, scale, 0.0F, 0, 0, 100, 100, false, false);

        if (this.renameHb.hovered) {
            sb.setColor(new Color(1.0F, 1.0F, 1.0F, 0.4F));
            sb.setBlendFunction(770, 1);
            sb.draw(ImageMaster.PROFILE_RENAME, this.renameHb.cX - 50.0F, this.renameHb.cY - 50.0F, 50.0F, 50.0F,
                    100.0F, 100.0F, scale, scale, 0.0F, 0, 0, 100, 100, false, false);
        ...
        if (this.slotHb.hovered && Settings.isControllerMode) {
            sb.draw(CInputActionSet.proceed
                    .getKeyImg(), this.renameHb.cX - 32.0F + 82.0F * Settings.scale, this.renameHb.cY - 32.0F, 32.0F,
                    32.0F, 64.0F, 64.0F, Settings.scale, Settings.scale, 0.0F, 0, 0, 64, 64, false, false);
        }
    }
 ...
 * SaveSlot.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
