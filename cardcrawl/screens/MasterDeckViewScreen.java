...
public class MasterDeckViewScreen
    ...
    public void update() {
        ...
        if (Settings.isControllerMode && this.controllerCard != null) {
            Gdx.input.setCursorPosition((int) this.controllerCard.hb.cX,
                    (int) (Settings.HEIGHT - this.controllerCard.hb.cY));
        }
    }
    ...
    private void updateControllerInput() {
        ...
        if (!anyHovered) {
            if (this.tmpSortedDeck.size() > 0) {
                Gdx.input.setCursorPosition((int) ((AbstractCard) this.tmpSortedDeck.get(0)).hb.cX,
    ...
    private void updatePositions() {
        ...
        if (cards.size() > 0 && this.sortHeader != null && c != null) {
            this.sortHeader.updateScrollPosition(
                    (this.headerScrollLockRemainingFrames <= 0) ? c.current_y : this.tmpHeaderPosition);
 ...
 * MasterDeckViewScreen.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
