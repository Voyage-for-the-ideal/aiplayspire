...
public class RelicViewScreen
    ...
    public void update() {
        if (!CardCrawlGame.relicPopup.isOpen) {
            ...
            if (Settings.isControllerMode && this.controllerRelicHb != null)
                Gdx.input.setCursorPosition((int) this.controllerRelicHb.cX,
                        (int) (Settings.HEIGHT - this.controllerRelicHb.cY));
        }
    }
    ...
    private void updateControllerInput() {
        ...
        if (!anyHovered) {
            Gdx.input.setCursorPosition(
                    (int) ((AbstractRelic) RelicLibrary.starterList.get(0)).hb.cX, Settings.HEIGHT -
                            (int) ((AbstractRelic) RelicLibrary.starterList.get(0)).hb.cY);
        } else {
            switch (category) {
                case STARTER:
                    ...
                    if (CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) {
                        ...
                        if (index > RelicLibrary.starterList.size() - 1) {
                            ...
                            Gdx.input.setCursorPosition(
                                    (int) ((AbstractRelic) RelicLibrary.commonList.get(index)).hb.cX, Settings.HEIGHT -
                                            (int) ((AbstractRelic) RelicLibrary.commonList.get(index)).hb.cY);
                            this.controllerRelicHb = ((AbstractRelic) RelicLibrary.commonList.get(index)).hb;
                        }
                        break;
                    }
                    if (CInputActionSet.left.isJustPressed() || CInputActionSet.altLeft.isJustPressed()) {
                        ...
                        Gdx.input.setCursorPosition(
                                (int) ((AbstractRelic) RelicLibrary.starterList.get(index)).hb.cX, Settings.HEIGHT -
                                        (int) ((AbstractRelic) RelicLibrary.starterList.get(index)).hb.cY);
                        this.controllerRelicHb = ((AbstractRelic) RelicLibrary.starterList.get(index)).hb;
                        break;
                    }
                ...
                case COMMON:
                    ...
                    if (CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) {
                        ...
                        if (index > RelicLibrary.commonList.size() - 1) {
                            ...
                            Gdx.input.setCursorPosition(
                                    (int) ((AbstractRelic) RelicLibrary.uncommonList.get(index)).hb.cX,
                                    Settings.HEIGHT -
                                            (int) ((AbstractRelic) RelicLibrary.uncommonList.get(index)).hb.cY);
                            this.controllerRelicHb = ((AbstractRelic) RelicLibrary.uncommonList.get(index)).hb;
                            break;
                        }
                        Gdx.input.setCursorPosition(
                                (int) ((AbstractRelic) RelicLibrary.commonList.get(index)).hb.cX, Settings.HEIGHT -
                ...
                case UNCOMMON:
                    if (CInputActionSet.up.isJustPressed() || CInputActionSet.altUp.isJustPressed()) {
                        ...
                        Gdx.input.setCursorPosition(
                                (int) ((AbstractRelic) RelicLibrary.uncommonList.get(index)).hb.cX, Settings.HEIGHT -
                                        (int) ((AbstractRelic) RelicLibrary.uncommonList.get(index)).hb.cY);
                        this.controllerRelicHb = ((AbstractRelic) RelicLibrary.uncommonList.get(index)).hb;
                        break;
                    }
                    if (CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) {
                        ...
                        if (index > RelicLibrary.uncommonList.size() - 1) {
                            ...
                            Gdx.input.setCursorPosition(
                                    (int) ((AbstractRelic) RelicLibrary.rareList.get(index)).hb.cX, Settings.HEIGHT -
                                            (int) ((AbstractRelic) RelicLibrary.rareList.get(index)).hb.cY);
                            this.controllerRelicHb = ((AbstractRelic) RelicLibrary.rareList.get(index)).hb;
                            break;
                        }
                        Gdx.input.setCursorPosition(
                                (int) ((AbstractRelic) RelicLibrary.uncommonList.get(index)).hb.cX, Settings.HEIGHT -
                ...
                case RARE:
                    ...
                    if (CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) {
                        ...
                        if (index > RelicLibrary.rareList.size() - 1) {
                            ...
                            Gdx.input.setCursorPosition(
                                    (int) ((AbstractRelic) RelicLibrary.bossList.get(index)).hb.cX, Settings.HEIGHT -
                                            (int) ((AbstractRelic) RelicLibrary.bossList.get(index)).hb.cY);
                            this.controllerRelicHb = ((AbstractRelic) RelicLibrary.bossList.get(index)).hb;
                            break;
                        }
                        Gdx.input.setCursorPosition(
                                (int) ((AbstractRelic) RelicLibrary.rareList.get(index)).hb.cX, Settings.HEIGHT -
                ...
                case BOSS:
                    ...
                    if (CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) {
                        ...
                        if (index > RelicLibrary.bossList.size() - 1) {
                            ...
                            Gdx.input.setCursorPosition(
                                    (int) ((AbstractRelic) RelicLibrary.specialList.get(index)).hb.cX, Settings.HEIGHT -
                                            (int) ((AbstractRelic) RelicLibrary.specialList.get(index)).hb.cY);
                            this.controllerRelicHb = ((AbstractRelic) RelicLibrary.specialList.get(index)).hb;
                            break;
                        }
                        Gdx.input.setCursorPosition(
                                (int) ((AbstractRelic) RelicLibrary.bossList.get(index)).hb.cX, Settings.HEIGHT -
                ...
                case EVENT:
                    ...
                    if (CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) {
                        ...
                        if (index > RelicLibrary.specialList.size() - 1) {
                            ...
                            Gdx.input.setCursorPosition(
                                    (int) ((AbstractRelic) RelicLibrary.shopList.get(index)).hb.cX, Settings.HEIGHT -
                                            (int) ((AbstractRelic) RelicLibrary.shopList.get(index)).hb.cY);
                            this.controllerRelicHb = ((AbstractRelic) RelicLibrary.shopList.get(index)).hb;
                            break;
                        }
                        Gdx.input.setCursorPosition(
                                (int) ((AbstractRelic) RelicLibrary.specialList.get(index)).hb.cX, Settings.HEIGHT -
 ...
 * \RelicViewScreen.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
