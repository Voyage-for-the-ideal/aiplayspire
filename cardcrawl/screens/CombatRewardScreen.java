...
public class CombatRewardScreen {
    ...
    public void setupItemReward() {
        ...
        if (((AbstractDungeon.getCurrRoom()).event == null || ((AbstractDungeon.getCurrRoom()).event != null &&
                !(AbstractDungeon.getCurrRoom()).event.noCardsInRewards)) &&
                !(AbstractDungeon.getCurrRoom() instanceof com.megacrit.cardcrawl.rooms.TreasureRoom) &&
    ...
    public void positionRewards() {
        for (int i = 0; i < this.rewards.size(); i++) {
            ((RewardItem) this.rewards.get(i))
                    .move(Settings.HEIGHT / 2.0F + 124.0F * Settings.scale - i * 100.0F * Settings.scale);
        }
    ...
    private void updateControllerInput() {
        if (!Settings.isControllerMode || this.rewards.isEmpty() || AbstractDungeon.topPanel.selectPotionMode
        ...
        if (!anyHovered) {
            ...
            Gdx.input.setCursorPosition(
                    (int) ((RewardItem) this.rewards.get(index)).hb.cX, Settings.HEIGHT -
                            (int) ((RewardItem) this.rewards.get(index)).hb.cY);
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderFontCentered(sb, FontHelper.panelNameFont, TEXT[12] + this.tip, Settings.WIDTH / 2.0F,
                this.tipY, Color.LIGHT_GRAY);
    ...
    private void renderItemReward(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.REWARD_SCREEN_SHEET, Settings.WIDTH / 2.0F - 306.0F,
                Settings.HEIGHT / 2.0F - 46.0F * Settings.scale - 358.0F, 306.0F, 358.0F, 612.0F, 716.0F,
                Settings.xScale, Settings.scale, 0.0F, 0, 0, 612, 716, false, false);
    ...
    public void open(String setLabel) {
        ...
        this.smoke = false;
        this.tip = CardCrawlGame.tips.getTip();
        this.tipY = Settings.HEIGHT - 1110.0F * Settings.scale;
 ...
 * CombatRewardScreen.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
