...
public class ToggleButton {
    ...
    public enum ToggleBtnType {
        FULL_SCREEN, W_FULL_SCREEN, SCREEN_SHAKE, AMBIENCE_ON, MUTE_IF_BG, SUM_DMG, BIG_TEXT, BLOCK_DMG, HAND_CONF, FAST_MODE, UPLOAD_DATA, LONG_PRESS, V_SYNC, PLAYTESTER_ART, SHOW_CARD_HOTKEYS, EFFECTS;
    }
    ...
    public void toggle() {
        ...
        switch (this.type) {
            ...
            case FULL_SCREEN:
                ...
                DisplayConfig.writeDisplayConfigFile(
                        (Gdx.graphics.getDisplayMode()).width,
                        (Gdx.graphics.getDisplayMode()).height, Settings.MAX_FPS, Settings.IS_FULLSCREEN,
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.OPTION_TOGGLE, this.x - 16.0F, this.y - 16.0F, 16.0F, 16.0F, 32.0F, 32.0F, scale, scale,
                0.0F, 0, 0, 32, 32, false, false);

        if (this.enabled) {
            sb.setColor(Color.WHITE);
            sb.draw(ImageMaster.OPTION_TOGGLE_ON, this.x - 16.0F, this.y - 16.0F, 16.0F, 16.0F, 32.0F, 32.0F, scale,
                    scale, 0.0F, 0, 0, 32, 32, false, false);
        }
 ...
 * ToggleButton.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
