...
public class ExitGameButton {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.OPTION_EXIT, this.x - this.W / 2.0F, this.y - this.H / 2.0F, this.W / 2.0F, this.H / 2.0F,
                this.W, this.H, Settings.scale, Settings.scale, 0.0F, 0, 0, this.W, this.H, false, false);

        FontHelper.renderFontCentered(sb, FontHelper.losePowerFont, this.label, this.x + 50.0F * Settings.scale,
                this.y - 170.0F * Settings.scale, Settings.GOLD_COLOR, 1.0F);

        if (this.hb.hovered) {
            sb.setBlendFunction(770, 1);
            sb.setColor(new Color(1.0F, 1.0F, 1.0F, 0.2F));
            sb.draw(ImageMaster.OPTION_EXIT, this.x - this.W / 2.0F, this.y - this.H / 2.0F, this.W / 2.0F,
                    this.H / 2.0F, this.W, this.H, Settings.scale, Settings.scale, 0.0F, 0, 0, this.W, this.H, false,
                    false);
        ...
        if (Settings.isControllerMode) {
            sb.draw(CInputActionSet.discardPile
                    ...
                    this.x - 32.0F - 32.0F * Settings.scale -
                            FontHelper.getSmartWidth(FontHelper.losePowerFont, this.label, 99999.0F, 0.0F) / 2.0F,
                    this.y - 32.0F - 170.0F * Settings.scale, 32.0F, 32.0F, 64.0F, 64.0F, Settings.scale,
 ...
 * ExitGameButton.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
