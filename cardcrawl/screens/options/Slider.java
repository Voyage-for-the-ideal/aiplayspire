...
public class Slider {
    ...
    public void render(SpriteBatch sb) {
        ...
        if (Settings.isControllerMode && this.bgHb.hovered) {
            sb.draw(ImageMaster.CONTROLLER_RS, this.bgHb.cX + 195.0F * Settings.scale,
                    this.bgHb.cY - 46.0F * Settings.scale, 32.0F, 32.0F, 64.0F, 64.0F, Settings.scale, Settings.scale,
                    0.0F, 0, 0, 64, 64, false, false);
        }

        sb.draw(ImageMaster.OPTION_SLIDER_BG, BG_X - 125.0F, this.y - 12.0F, 125.0F, 12.0F, 250.0F, 24.0F,
                Settings.scale, Settings.scale, 0.0F, 0, 0, 250, 24, false, false);

        if (this.sliderGrabbed) {
            FontHelper.renderFontCentered(sb, FontHelper.tipBodyFont, df

                    .format((this.volume * 100.0F)) + '%', BG_X + 170.0F * Settings.scale, this.y,
        ...
        sb.draw(ImageMaster.OPTION_SLIDER, this.x - 22.0F, this.y - 22.0F, 22.0F, 22.0F, 44.0F, 44.0F, Settings.scale,
                Settings.scale, 0.0F, 0, 0, 44, 44, false, false);
 ...
 * Slider.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
