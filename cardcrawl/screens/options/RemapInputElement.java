...
public class RemapInputElement
    ...
    public RemapInputElement(RemapInputElementListener listener, String label, InputAction action,
            CInputAction controllerAction) {
        this.hb = new Hitbox(ROW_WIDTH, ROW_HEIGHT);
    ...
    public void render(SpriteBatch sb) {
        ...
        if (!this.isHeader) {
            ...
            if (img != null) {
                sb.draw(img, textX - 32.0F, textY - 32.0F - 10.0F * Settings.scale, 32.0F, 32.0F, 64.0F, 64.0F,
 ...
 * RemapInputElement.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
