...
public class DrawPileViewScreen
    ...
    private void updateControllerInput() {
        ...
        if (!anyHovered) {
            Gdx.input.setCursorPosition(
                    (int) ((AbstractCard) this.drawPileCopy.group.get(0)).hb.cX, Settings.HEIGHT -
                            (int) ((AbstractCard) this.drawPileCopy.group.get(0)).hb.cY);
            ...
            Gdx.input.setCursorPosition(
                    (int) ((AbstractCard) this.drawPileCopy.group.get(index)).hb.cX, Settings.HEIGHT -
                            (int) ((AbstractCard) this.drawPileCopy.group.get(index)).hb.cY);
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderFontLeftTopAligned(sb, FontHelper.panelNameFont, TEXT[3], 166.0F * Settings.scale,
 ...
 * DrawPileViewScreen.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
