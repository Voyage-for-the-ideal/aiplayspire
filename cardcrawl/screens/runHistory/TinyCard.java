...
public class TinyCard {
    ...
    public void render(SpriteBatch sb) {
        ...
        if (this.hb.hovered) {
            FontHelper.renderSmartText(sb, FontHelper.charDescFont, text,
                    x + TEXT_LEADING_SPACE + (3.0f * Settings.scale), y + height + textOffset, 9999.0f, LINE_SPACING,
                    textColor);
        } else {
            FontHelper.renderSmartText(sb, FontHelper.charDescFont, text, x + TEXT_LEADING_SPACE,
                    y + height + textOffset, 9999.0f, LINE_SPACING, textColor);
        }
        this.hb.render(sb);
    }
