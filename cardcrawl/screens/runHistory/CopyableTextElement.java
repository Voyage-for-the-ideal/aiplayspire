...
public class CopyableTextElement {
    ...
    public float approximateWidth() {
        return FontHelper.getSmartWidth(this.font, getText(), Float.MAX_VALUE, 36.0F * Settings.scale);
    }
    ...
    public void setText(String text) {
        this.text = text;
        this.hb.width = approximateWidth() + 2.0F * HITBOX_PADDING;
    }
 ...
 * \CopyableTextElement.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
