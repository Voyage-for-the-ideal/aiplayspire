        ...
        if (!this.isSilenced) {
            ...
            if (this.fadeTimer < 0.0F) {
                ...
                if (!Settings.isBackgrounded) {
                    this.music.setVolume(Interpolation.fade
                            .apply(0.0F, 1.0F, 1.0F - this.fadeTimer / this.fadeTime) * Settings.MUSIC_VOLUME
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\audio\TempMusic.
