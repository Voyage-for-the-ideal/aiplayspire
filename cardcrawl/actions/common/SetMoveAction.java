...
public class SetMoveAction
    ...
    public SetMoveAction(AbstractMonster monster, String moveName, byte nextMove, AbstractMonster.Intent intent,
            int baseDamage, int multiplierAmt, boolean multiplier) {
    ...
    public SetMoveAction(AbstractMonster monster, byte nextMove, AbstractMonster.Intent intent, int baseDamage,
            int multiplierAmt, boolean multiplier) {
    ...
    public void update() {
        this.monster.setMove(this.theNextName, this.theNextMove, this.theNextIntent, this.theNextDamage,
                this.theMultiplier, this.isMultiplier);
        this.isDone = true;
    }
}
 ...
 * SetMoveAction.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
