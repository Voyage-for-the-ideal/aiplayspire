    ...
    public void update() {
        if (this.duration == this.startDuration) {
            ...
            if (this.numberOfCards == 1) {
                ...
                AbstractDungeon.gridSelectScreen.open(temp, this.numberOfCards, true,
                        TEXT[1] + this.numberOfCards + TEXT[2]);

            } else {

                AbstractDungeon.gridSelectScreen.open(temp, this.numberOfCards, TEXT[1] + this.numberOfCards + TEXT[2],
                        false);
            }
 ...
 * BetterDrawPileToHandAction.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
