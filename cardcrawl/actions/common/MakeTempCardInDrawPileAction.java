...
public class MakeTempCardInDrawPileAction
    ...
    public MakeTempCardInDrawPileAction(AbstractCard card, int amount, boolean randomSpot, boolean autoPosition,
            boolean toBottom, float cardX, float cardY) {
        ...
        if (this.duration == this.startDuration) {
            ...
            if (this.amount < 6) {
                for (int i = 0; i < this.amount; i++) {
                    ...
                    AbstractDungeon.effectList.add(new ShowCardAndAddToDrawPileEffect(c, this.x, this.y,
                            this.randomSpot, this.autoPosition, this.toBottom));
                }
            } else {
                ...
                for (int i = 0; i < this.amount; i++) {
                    ...
                    AbstractDungeon.effectList
                            .add(new ShowCardAndAddToDrawPileEffect(c, this.randomSpot, this.toBottom));
                }
            }
 ...
 * MakeTempCardInDrawPileAction.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
