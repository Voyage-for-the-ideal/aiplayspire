...
public class RelicAboveCreatureAction
    ...
    public void update() {
        if (!this.used) {
            AbstractDungeon.effectList.add(new RelicAboveCreatureEffect(this.source.hb.cX - this.source.animX,
                    this.source.hb.cY + this.source.hb.height / 2.0F - this.source.animY, this.relic));
 ...
 * RelicAboveCreatureAction.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
