    ...
    private void stealGold() {
        ...
        for (int i = 0; i < this.goldAmount; i++) {
            if (this.source.isPlayer) {
                ...
                AbstractDungeon.effectList.add(new GainPennyEffect(this.source, this.target.hb.cX, this.target.hb.cY,
                        this.source.hb.cX, this.source.hb.cY, false));
            }
        }
    }
}
 ...
 * DamageAction.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
