    ...
    public void update() {
        if (this.duration == Settings.ACTION_DUR_FAST) {
            ...
            if (this.upgraded) {
                ...
                AbstractCard c = this.p.hand.group
                        .get(AbstractDungeon.cardRandomRng.random(0, this.p.hand.group.size() - 1));
                c.upgrade();
                c.superFlash();
                this.isDone = true;
            }
 ...
 * ContemplateAction.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
