    ...
    public void update() {
        if (!this.hitAll) {
            ...
            if (abstractMonster != null) {
                ...
                if (this.orb != null) {
                    addToTop((AbstractGameAction) new VFXAction(
                            (AbstractGameEffect) new OrbFlareEffect(this.orb, OrbFlareEffect.OrbFlareColor.LIGHTNING),
                            speedTime));
                }
            }
        } else {
 ...
 * LightningOrbPassiveAction.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
