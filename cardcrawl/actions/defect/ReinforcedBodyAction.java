    ...
    public void update() {
        ...
        if (effect > 0) {
            for (int i = 0; i < effect; i++) {
                addToBot((AbstractGameAction) new GainBlockAction((AbstractCreature) this.p, (AbstractCreature) this.p,
                        this.amount));
            }
 ...
 * ReinforcedBodyAction.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
