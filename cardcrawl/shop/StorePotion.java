...
public class StorePotion {
    ...
    public void update(float rugY) {
        if (this.potion != null) {
            ...
            if (!this.isPurchased) {
                this.potion.posX = 1000.0F * Settings.xScale + 150.0F * this.slot * Settings.xScale;
                ...
                if (this.potion.hb.hovered) {
                    this.shopScreen.moveHand(this.potion.posX - 190.0F * Settings.scale,
    ...
    public void render(SpriteBatch sb) {
        if (this.potion != null) {
            ...
            sb.draw(ImageMaster.UI_GOLD, this.potion.posX + RELIC_GOLD_OFFSET_X, this.potion.posY + RELIC_GOLD_OFFSET_Y,
            ...
            FontHelper.renderFontLeftTopAligned(sb, FontHelper.tipHeaderFont,
                    ...
                    Integer.toString(this.price), this.potion.posX + RELIC_PRICE_OFFSET_X,
                    this.potion.posY + RELIC_PRICE_OFFSET_Y, color);
        }
    }
}
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\shop\StorePotion.
