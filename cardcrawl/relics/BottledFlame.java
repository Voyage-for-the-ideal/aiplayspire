...
public class BottledFlame extends AbstractRelic {
    ...
    public BottledFlame() {
        super("Bottled Flame", "bottledFlame.png", RelicTier.UNCOMMON, LandingSound.CLINK);
    }
    ...
    public void onEquip() {
        if (AbstractDungeon.player.masterDeck.getPurgeableCards().getAttacks().size() > 0) {
            ...
            AbstractDungeon.gridSelectScreen.open(AbstractDungeon.player.masterDeck
                    .getPurgeableCards().getAttacks(), 1, this.DESCRIPTIONS[1] + this.name + LocalizedStrings.PERIOD,
 ...
 * BottledFlame.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
