...
public class FossilizedHelix extends AbstractRelic {
    public FossilizedHelix() {
        super("FossilizedHelix", "helix.png", RelicTier.RARE, LandingSound.HEAVY);
    }
    ...
    public void atBattleStart() {
        ...
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) AbstractDungeon.player,
                ...
                (AbstractPower) new BufferPower((AbstractCreature) AbstractDungeon.player, 1), 1));
 ...
 * FossilizedHelix.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
