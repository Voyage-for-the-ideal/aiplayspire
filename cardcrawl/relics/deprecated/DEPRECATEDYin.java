...
public class DEPRECATEDYin extends AbstractRelic {
    public DEPRECATEDYin() {
        super("Yin", "yin.png", RelicTier.UNCOMMON, LandingSound.MAGICAL);
    }
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (card.type == AbstractCard.CardType.SKILL) {
            ...
            addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                    (AbstractPower) new StrengthPower((AbstractCreature) p, 1), 1));
            addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                    (AbstractPower) new LoseStrengthPower((AbstractCreature) p, 1), 1));
        }
    }
 ...
 * DEPRECATEDYin.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
