...
public class BloodVial extends AbstractRelic {
    ...
    public BloodVial() {
        super("Blood Vial", "blood_vial.png", RelicTier.COMMON, LandingSound.CLINK);
    }
    ...
    public void atBattleStart() {
        ...
        addToTop((AbstractGameAction) new HealAction((AbstractCreature) AbstractDungeon.player,
                (AbstractCreature) AbstractDungeon.player, 2, 0.0F));
    }
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\relics\BloodVial.
