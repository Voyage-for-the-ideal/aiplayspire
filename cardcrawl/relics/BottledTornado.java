...
public class BottledTornado extends AbstractRelic {
    ...
    public BottledTornado() {
        super("Bottled Tornado", "bottledTornado.png", RelicTier.UNCOMMON, LandingSound.CLINK);
    }
    ...
    public void onEquip() {
        if (AbstractDungeon.player.masterDeck.getPurgeableCards().getPowers().size() > 0) {
            ...
            AbstractDungeon.gridSelectScreen.open(AbstractDungeon.player.masterDeck
                    .getPurgeableCards().getPowers(), 1, this.DESCRIPTIONS[1] + this.name + LocalizedStrings.PERIOD,
 ...
 * BottledTornado.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
