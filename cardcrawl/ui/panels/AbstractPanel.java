...
public abstract class AbstractPanel {
    ...
    public AbstractPanel(float show_x, float show_y, float hide_x, float hide_y, float shadow_offset_x,
            float shadow_offset_y, Texture img, boolean startHidden) {
        this.img = img;
        this.show_x = show_x;
        this.show_y = show_y;
        this.hide_x = hide_x;
    ...
    public void render(SpriteBatch sb) {
        if (this.img != null) {
            ...
            sb.draw(this.img, this.current_x, this.current_y, this.img_width, this.img_height, 0, 0, this.img
 ...
 * AbstractPanel.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
