...
public class DrawPilePanel
    ...
    public void updatePositions() {
        ...
        // 53: ifeq -> 95
        // 56: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.screen :
        // Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 59: getstatic
        // com/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen.GAME_DECK_VIEW
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 62: if_acmpeq -> 95
        // 65: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.screen :
        // Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 68: getstatic
        // com/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen.HAND_SELECT :
        // Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 71: if_acmpeq -> 95
        // 74: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.screen :
        // Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 77: getstatic
        ...
        // 89: getstatic com/megacrit/cardcrawl/rooms/AbstractRoom$RoomPhase.COMBAT :
        // Lcom/megacrit/cardcrawl/rooms/AbstractRoom$RoomPhase;
        // 92: if_acmpne -> 116
        // 95: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.overlayMenu :
        // Lcom/megacrit/cardcrawl/core/OverlayMenu;
        // 98: iconst_1
        // 99: putfield hoveredTip : Z
        // 102: getstatic
        // com/megacrit/cardcrawl/helpers/input/InputHelper.justClickedLeft : Z
        // 105: ifeq -> 116
        // 108: aload_0
        ...
        // 123: ifne -> 144
        // 126: getstatic com/megacrit/cardcrawl/helpers/input/InputActionSet.drawPile :
        // Lcom/megacrit/cardcrawl/helpers/input/InputAction;
        // 129: invokevirtual isJustPressed : ()Z
        // 132: ifne -> 144
        // 135: getstatic
        // com/megacrit/cardcrawl/helpers/controller/CInputActionSet.drawPile :
        // Lcom/megacrit/cardcrawl/helpers/controller/CInputAction;
        // 138: invokevirtual isJustPressed : ()Z
        // 141: ifeq -> 203
        // 144: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.screen :
        // Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 147: getstatic
        // com/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen.GAME_DECK_VIEW
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        ...
        // 177: getstatic com/megacrit/cardcrawl/core/CardCrawlGame.sound :
        // Lcom/megacrit/cardcrawl/audio/SoundMaster;
        // 180: ldc 'DECK_CLOSE'
        // 182: invokevirtual play : (Ljava/lang/String;)J
        // 185: pop2
        // 186: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.previousScreen
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 189: getstatic
        // com/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen.GAME_DECK_VIEW
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 192: if_acmpne -> 199
        // 195: aconst_null
        // 196: putstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.previousScreen
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        ...
        // 288: ifne -> 309
        // 291: getstatic com/megacrit/cardcrawl/helpers/input/InputActionSet.drawPile :
        // Lcom/megacrit/cardcrawl/helpers/input/InputAction;
        ...
        // 306: ifeq -> 416
        // 309: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.overlayMenu :
        // Lcom/megacrit/cardcrawl/core/OverlayMenu;
        // 312: getfield combatPanelsShown : Z
        // 315: ifeq -> 416
        // 318: invokestatic getMonsters :
        // ()Lcom/megacrit/cardcrawl/monsters/MonsterGroup;
        // 321: ifnull -> 416
        // 324: invokestatic getMonsters :
        // ()Lcom/megacrit/cardcrawl/monsters/MonsterGroup;
        // 327: invokevirtual areMonstersDead : ()Z
        // 330: ifne -> 416
        // 333: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.player :
        ...
        // 366: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.dynamicBanner
        // : Lcom/megacrit/cardcrawl/ui/buttons/DynamicBanner;
        // 369: invokevirtual hide : ()V
        // 372: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.player :
        // Lcom/megacrit/cardcrawl/characters/AbstractPlayer;
        // 375: getfield hoveredCard : Lcom/megacrit/cardcrawl/cards/AbstractCard;
        // 378: ifnull -> 387
        // 381: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.player :
        // Lcom/megacrit/cardcrawl/characters/AbstractPlayer;
        // 384: invokevirtual releaseCard : ()V
        // 387: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.isScreenUp : Z
        // 390: ifeq -> 408
        // 393: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.previousScreen
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 396: ifnonnull -> 412
        // 399: getstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.screen :
        // Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 402: putstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.previousScreen
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 405: goto -> 412
        // 408: aconst_null
        // 409: putstatic com/megacrit/cardcrawl/dungeons/AbstractDungeon.previousScreen
        // : Lcom/megacrit/cardcrawl/dungeons/AbstractDungeon$CurrentScreen;
        // 412: aload_0
    ...
    public void render(SpriteBatch sb) {
        if (this.hb.hovered
                || (this.bannerHb.hovered && AbstractDungeon.screen == AbstractDungeon.CurrentScreen.GAME_DECK_VIEW)) {
        ...
        sb.draw(ImageMaster.DECK_BTN_BASE, this.current_x + DECK_X, this.current_y + DECK_Y + this.bob.y / 2.0F, 64.0F,
                64.0F, 128.0F, 128.0F, this.scale, this.scale, 0.0F, 0, 0, 128, 128, false, false);

        String msg = Integer.toString(AbstractDungeon.player.drawPile.size());
        this.gl.setText(FontHelper.turnNumFont, msg);
        sb.setColor(Color.WHITE);
        sb.draw(ImageMaster.DECK_COUNT_CIRCLE, this.current_x + COUNT_OFFSET_X, this.current_y + COUNT_OFFSET_Y,
                COUNT_CIRCLE_W, COUNT_CIRCLE_W);

        if (Settings.isControllerMode) {
            sb.draw(CInputActionSet.drawPile
                    .getKeyImg(), this.current_x - 32.0F + 30.0F * Settings.scale,
                    this.current_y - 32.0F + 40.0F * Settings.scale, 32.0F, 32.0F, 64.0F, 64.0F, Settings.scale * 0.75F,
                    Settings.scale * 0.75F, 0.0F, 0, 0, 64, 64, false, false);
        }

        FontHelper.renderFontCentered(sb, FontHelper.turnNumFont, msg, this.current_x + COUNT_X,
                this.current_y + COUNT_Y);
        ...
        if (this.hb.hovered &&
            ...
            if (Settings.isConsoleBuild) {
                if (!AbstractDungeon.player.hasRelic("Frozen Eye")) {
                    TipHelper.renderGenericTip(DECK_TIP_X, DECK_TIP_Y, LABEL[0] + " (" + InputActionSet.drawPile

                            .getKeyString() + ")", MSG[0] + AbstractDungeon.player.gameHandSize + MSG[3]);
                } else {

                    TipHelper.renderGenericTip(DECK_TIP_X, DECK_TIP_Y, LABEL[0] + " (" + InputActionSet.drawPile

                            .getKeyString() + ")", MSG[0] + AbstractDungeon.player.gameHandSize + MSG[4]);
                }

            } else if (!AbstractDungeon.player.hasRelic("Frozen Eye")) {
                TipHelper.renderGenericTip(DECK_TIP_X, DECK_TIP_Y, LABEL[0] + " (" + InputActionSet.drawPile

                        .getKeyString() + ")", MSG[0] + AbstractDungeon.player.gameHandSize + MSG[1]);
            } else {

                TipHelper.renderGenericTip(DECK_TIP_X, DECK_TIP_Y, LABEL[0] + " (" + InputActionSet.drawPile

                        .getKeyString() + ")", MSG[0] + AbstractDungeon.player.gameHandSize + MSG[2]);
            }
        }
    }
}
 ...
 * DrawPilePanel.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
