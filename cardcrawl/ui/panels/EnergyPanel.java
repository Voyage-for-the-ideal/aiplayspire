...
public class EnergyPanel
    ...
    public EnergyPanel() {
        super(198.0F * Settings.xScale, 190.0F * Settings.yScale, -480.0F * Settings.scale, 200.0F * Settings.yScale,
                12.0F * Settings.scale, -12.0F * Settings.scale, null, true);
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderFontCentered(sb, AbstractDungeon.player

                .getEnergyNumFont(), energyMsg, this.current_x, this.current_y, ENERGY_TEXT_COLOR);

        this.tipHitbox.render(sb);
        if (this.tipHitbox.hovered && (AbstractDungeon.getCurrRoom()).phase == AbstractRoom.RoomPhase.COMBAT
    ...
    private void renderVfx(SpriteBatch sb) {
        if (energyVfxTimer != 0.0F) {
            ...
            sb.draw(this.gainEnergyImg, this.current_x - 128.0F, this.current_y - 128.0F, 128.0F, 128.0F, 256.0F,
 ...
 * EnergyPanel.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
