...
public class RenamePopup {
    ...
    public void confirm() {
        ...
        if (this.newSave) {
            ...
            logger.info("UPDATING DEFAULT SLOT: ", Integer.valueOf(this.slot));
            CardCrawlGame.saveSlotPref.putInteger("DEFAULT_SLOT", this.slot);
            saveSlotPrefSave = true;
            CardCrawlGame.reloadPrefs();

            if (!CardCrawlGame.saveSlotPref.getString(SaveHelper.slotName("PROFILE_NAME", this.slot), "")
                    .equals(textField)) {
        ...
        } else if (!CardCrawlGame.saveSlotPref.getString(SaveHelper.slotName("PROFILE_NAME", this.slot), "")
                .equals(textField)) {
    ...
    private void renderTextbox(SpriteBatch sb) {
        sb.draw(ImageMaster.RENAME_BOX, Settings.WIDTH / 2.0F - 160.0F,
                Settings.OPTION_Y + 20.0F * Settings.scale - 160.0F, 160.0F, 160.0F, 320.0F, 320.0F, Settings.scale,
                Settings.scale, 0.0F, 0, 0, 320, 320, false, false);

        FontHelper.renderSmartText(sb, FontHelper.cardTitleFont, textField,
                Settings.WIDTH / 2.0F - 120.0F * Settings.scale, Settings.OPTION_Y + 24.0F * Settings.scale, 100000.0F,
 ...
 * RenamePopup.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
