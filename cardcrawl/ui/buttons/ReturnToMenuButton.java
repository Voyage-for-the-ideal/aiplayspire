...
public class ReturnToMenuButton {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.DYNAMIC_BTN_IMG2, this.x - 256.0F, this.y - 256.0F, 256.0F, 256.0F, 512.0F, 512.0F,
                Settings.scale, Settings.scale, 0.0F, 0, 0, 512, 512, false, false);

        if (this.hb.clickStarted) {
            FontHelper.renderFontCentered(sb, FontHelper.panelEndTurnFont, this.label, this.x, this.y,
                    Color.LIGHT_GRAY);
        } else {
        ...
        if (Settings.isControllerMode) {
            sb.draw(CInputActionSet.select
                    .getKeyImg(), Settings.WIDTH / 2.0F - 32.0F - 100.0F * Settings.scale, this.y - 32.0F, 32.0F, 32.0F,
 ...
 * ReturnToMenuButton.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
