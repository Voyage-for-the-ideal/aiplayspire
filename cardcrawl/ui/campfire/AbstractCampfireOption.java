...
public abstract class AbstractCampfireOption {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, (this.hb.cX - 128.0f) + SHDW_X, (this.hb.cY - 128.0f) + SHDW_Y, 128.0f, 128.0f, 256.0f,
                256.0f, this.scale, this.scale, 0.0f, 0, 0, 256, 256, false, false);
        sb.setColor(new Color(1.0f, 0.93f, 0.45f, scaler));
        sb.draw(ImageMaster.CAMPFIRE_HOVER_BUTTON, this.hb.cX - 128.0f, this.hb.cY - 128.0f, 128.0f, 128.0f, 256.0f,
                256.0f, this.scale * 1.075f, this.scale * 1.075f, 0.0f, 0, 0, 256, 256, false, false);
        sb.setColor(this.color);
        if (!this.usable) {
            ShaderHelper.setShader(sb, ShaderHelper.Shader.GRAYSCALE);
        }
        sb.draw(this.img, this.hb.cX - 128.0f, this.hb.cY - 128.0f, 128.0f, 128.0f, 256.0f, 256.0f, this.scale,
        ...
        if (!this.usable) {
            FontHelper.renderFontCenteredTopAligned(sb, FontHelper.topPanelInfoFont, this.label, this.hb.cX,
                    (this.hb.cY - (60.0f * Settings.scale))
                            - ((50.0f * Settings.scale) * (this.scale / Settings.scale)),
                    Color.LIGHT_GRAY);
        } else {
            FontHelper.renderFontCenteredTopAligned(sb, FontHelper.topPanelInfoFont, this.label, this.hb.cX,
                    (this.hb.cY - (60.0f * Settings.scale))
        ...
        FontHelper.renderFontCenteredTopAligned(sb, FontHelper.topPanelInfoFont, this.description,
                950.0f * Settings.xScale, (Settings.HEIGHT / 2.0f) + (20.0f * Settings.scale), this.descriptionColor);
        this.hb.render(sb);
    }
}
