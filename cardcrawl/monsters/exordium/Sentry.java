                ...
                if (!Settings.FAST_MODE) {
                    AbstractDungeon.actionManager
                            .addToBottom((AbstractGameAction) new VFXAction((AbstractCreature) this,
                                    (AbstractGameEffect) new ShockWaveEffect(this.hb.cX, this.hb.cY, Color.ROYAL,
                                            ShockWaveEffect.ShockWaveType.ADDITIVE),
                                    0.5F));

                    AbstractDungeon.actionManager.addToBottom((AbstractGameAction) new FastShakeAction(
                            (AbstractCreature) AbstractDungeon.player, 0.6F, 0.2F));
                } else {
                    AbstractDungeon.actionManager
                            .addToBottom((AbstractGameAction) new VFXAction((AbstractCreature) this,
                                    (AbstractGameEffect) new ShockWaveEffect(this.hb.cX, this.hb.cY, Color.ROYAL,
                    ...
                    AbstractDungeon.actionManager.addToBottom((AbstractGameAction) new FastShakeAction(
                            (AbstractCreature) AbstractDungeon.player, 0.6F, 0.15F));
                }
                AbstractDungeon.actionManager
                        .addToBottom((AbstractGameAction) new MakeTempCardInDiscardAction((AbstractCard) new Dazed(),
                                this.dazedAmt));
                break;
            case 4:
    ...
    protected void getMove(int num) {
        if (this.firstMove) {
            if ((AbstractDungeon.getMonsters()).monsters.lastIndexOf(this) % 2 == 0) {
                ...
                setMove((byte) 4, Intent.ATTACK, ((DamageInfo) this.damage.get(0)).base);
            }
 ...
 * Sentry.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
