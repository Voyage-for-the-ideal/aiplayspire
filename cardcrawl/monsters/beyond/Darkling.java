...
public class Darkling extends AbstractMonster {
    ...
    public Darkling(float x, float y) {
        ...
        loadAnimation("images/monsters/theForest/darkling/skeleton.atlas",
                "images/monsters/theForest/darkling/skeleton.json", 1.0F);
    ...
    public void usePreBattleAction() {
        ...
        AbstractDungeon.actionManager.addToBottom((AbstractGameAction) new ApplyPowerAction((AbstractCreature) this,
                (AbstractCreature) this, (AbstractPower) new RegrowPower((AbstractCreature) this)));
    }
    ...
    public void takeTurn() {
        switch (this.nextMove) {
            ...
            case 2:
                AbstractDungeon.actionManager.addToBottom(
                        (AbstractGameAction) new GainBlockAction((AbstractCreature) this, (AbstractCreature) this, 12));
            ...
            case 4:
                AbstractDungeon.actionManager.addToBottom(
                        (AbstractGameAction) new TextAboveCreatureAction((AbstractCreature) this, DIALOG[0]));
                break;
            case 5:
                ...
                AbstractDungeon.actionManager.addToBottom((AbstractGameAction) new HealAction((AbstractCreature) this,
                        (AbstractCreature) this, this.maxHealth / 2));
                ...
                AbstractDungeon.actionManager
                        .addToBottom((AbstractGameAction) new ApplyPowerAction((AbstractCreature) this,
                                (AbstractCreature) this, (AbstractPower) new RegrowPower((AbstractCreature) this), 1));
        ...
        if (this.currentHealth <= 0 && !this.halfDead) {
            ...
            if (!allDead) {
                if (this.nextMove != 4) {
                    ...
                    createIntent();
                    AbstractDungeon.actionManager
                            .addToBottom((AbstractGameAction) new SetMoveAction(this, (byte) 4, Intent.UNKNOWN));
                }
            } else {
 ...
 * Darkling.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
