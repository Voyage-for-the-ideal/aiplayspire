...
public class PowerPotion extends AbstractPotion {
    ...
    public PowerPotion() {
        super(potionStrings.NAME, "PowerPotion", PotionRarity.COMMON, PotionSize.CARD, PotionColor.BLUE);
        this.isThrown = false;
    }
    ...
    public void use(AbstractCreature target) {
        addToBot((AbstractGameAction) new DiscoveryAction(AbstractCard.CardType.POWER, this.potency));
    }
 ...
 * PowerPotion.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
