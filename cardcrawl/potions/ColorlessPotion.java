...
public class ColorlessPotion extends AbstractPotion {
    ...
    public ColorlessPotion() {
        super(potionStrings.NAME, "ColorlessPotion", PotionRarity.COMMON, PotionSize.CARD, PotionColor.WHITE);
        this.isThrown = false;
    }
    ...
    public void use(AbstractCreature target) {
        addToBot((AbstractGameAction) new DiscoveryAction(true, this.potency));
    }
 ...
 * ColorlessPotion.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
