...
public class NeowReward {
    ...
    private static final CharacterStrings characterStrings = CardCrawlGame.languagePack
            .getCharacterString("Neow Reward");
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/neow/NeowReward$NeowRewardDrawback.
     * class
     */
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/neow/NeowReward$NeowRewardType.class
     */
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/neow/NeowReward$NeowRewardDef.class
     */
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/neow/NeowReward$NeowRewardDrawbackDef.
     * class
     */
    ...
    private ArrayList<NeowRewardDrawbackDef> getRewardDrawbackOptions() {
        ...
        drawbackOptions.add(
                new NeowRewardDrawbackDef(NeowRewardDrawback.TEN_PERCENT_HP_LOSS, TEXT[17] + this.hp_bonus + TEXT[18]));
        ...
        drawbackOptions.add(new NeowRewardDrawbackDef(NeowRewardDrawback.PERCENT_DAMAGE,
    ...
    private ArrayList<NeowRewardDef> getRewardOptions(int category) {
        ...
        switch (category) {
            ...
            case 1:
                ...
                rewardOptions
                        .add(new NeowRewardDef(NeowRewardType.TEN_PERCENT_HP_BONUS, TEXT[7] + this.hp_bonus + " ]"));
        ...
        if (this.activated) {
                ...
                switch (this.type) {
                    ...
                    case REMOVE_CARD:
                        ...
                        AbstractDungeon.player.masterDeck
                                .removeCard(AbstractDungeon.gridSelectScreen.selectedCards.get(0));
                        break;
                    case REMOVE_TWO:
                        CardCrawlGame.sound.play("CARD_EXHAUST");
                        ...
                        AbstractDungeon.topLevelEffects.add(new PurgeCardEffect(c2,
                                ((Settings.WIDTH / 2.0f) - (AbstractCard.IMG_WIDTH / 2.0f)) - (30.0f * Settings.scale),
                                Settings.HEIGHT / 2));
                        AbstractDungeon.topLevelEffects.add(new PurgeCardEffect(c3,
                                (Settings.WIDTH / 2.0f) + (AbstractCard.IMG_WIDTH / 2.0f) + (30.0f * Settings.scale),
                        ...
                        break;
                    case TRANSFORM_CARD:
                        AbstractDungeon.transformCard(AbstractDungeon.gridSelectScreen.selectedCards.get(0), false,
                                NeowEvent.rng);
                        AbstractDungeon.player.masterDeck
                                .removeCard(AbstractDungeon.gridSelectScreen.selectedCards.get(0));
                    ...
                    case TRANSFORM_TWO_CARDS:
                        ...
                        AbstractDungeon.topLevelEffects
                                .add(new ShowCardAndObtainEffect(
                                        AbstractDungeon.getTransformedCard(), (Settings.WIDTH / 2.0f)
            ...
            if (this.cursed) {
                ...
                AbstractDungeon.topLevelEffects.add(
                        new ShowCardAndObtainEffect(AbstractDungeon.getCardWithoutRng(AbstractCard.CardRarity.CURSE),
    ...
    public void activate() {
        ...
        switch (this.drawback) {
            ...
            case TEN_PERCENT_HP_LOSS:
                ...
                break;
            case PERCENT_DAMAGE:
                AbstractDungeon.player.damage(new DamageInfo(null, (AbstractDungeon.player.currentHealth / 10) * 3,
        ...
        switch (this.type) {
            case UPGRADE_CARD:
                AbstractDungeon.gridSelectScreen.open(AbstractDungeon.player.masterDeck.getUpgradableCards(), 1,
                        TEXT[27], true, false, false, false);
                break;
            case REMOVE_CARD:
                AbstractDungeon.gridSelectScreen.open(AbstractDungeon.player.masterDeck.getPurgeableCards(), 1,
                        TEXT[23], false, false, false, true);
                break;
            case REMOVE_TWO:
                AbstractDungeon.gridSelectScreen.open(AbstractDungeon.player.masterDeck.getPurgeableCards(), 2,
                        TEXT[24], false, false, false, false);
                break;
            case TRANSFORM_CARD:
                AbstractDungeon.gridSelectScreen.open(AbstractDungeon.player.masterDeck.getPurgeableCards(), 1,
                        TEXT[25], false, true, false, false);
                break;
            case TRANSFORM_TWO_CARDS:
                AbstractDungeon.gridSelectScreen.open(AbstractDungeon.player.masterDeck.getPurgeableCards(), 2,
                        TEXT[26], false, false, false, false);
                break;
            case RANDOM_COLORLESS_2:
                AbstractDungeon.cardRewardScreen.open(getColorlessRewardCards(true), null,
                        CardCrawlGame.languagePack.getUIString("CardRewardScreen").TEXT[1]);
                break;
            case RANDOM_COLORLESS:
                AbstractDungeon.cardRewardScreen.open(getColorlessRewardCards(false), null,
                        CardCrawlGame.languagePack.getUIString("CardRewardScreen").TEXT[1]);
                break;
            ...
            case TEN_PERCENT_HP_BONUS:
                ...
                break;
            case THREE_CARDS:
                AbstractDungeon.cardRewardScreen.open(getRewardCards(false), null,
                        CardCrawlGame.languagePack.getUIString("CardRewardScreen").TEXT[1]);
                break;
