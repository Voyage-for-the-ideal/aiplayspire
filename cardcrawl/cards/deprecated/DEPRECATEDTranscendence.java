...
public class DEPRECATEDTranscendence extends AbstractCard {
    ...
    public DEPRECATEDTranscendence() {
        super("Transcendence", cardStrings.NAME, null, 1, cardStrings.DESCRIPTION, CardType.SKILL, CardColor.PURPLE,
                CardRarity.RARE, CardTarget.NONE);
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new TranscendenceAction());
    }
 ...
 * DEPRECATEDTranscendence.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
