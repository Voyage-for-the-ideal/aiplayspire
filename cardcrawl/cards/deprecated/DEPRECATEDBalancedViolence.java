...
public class DEPRECATEDBalancedViolence
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack
            .getCardStrings("DEPRECATEDBalancedViolence");

    public DEPRECATEDBalancedViolence() {
        super("DEPRECATEDBalancedViolence", cardStrings.NAME, null, 1, cardStrings.DESCRIPTION, CardType.ATTACK,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot((AbstractGameAction) new StanceCheckAction("Calm",
                (AbstractGameAction) new DrawCardAction(this.magicNumber)));
    }
 ...
 * DEPRECATEDBalancedViolence.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
