...
public class DEPRECATEDGrounded extends AbstractCard {
    ...
    public DEPRECATEDGrounded() {
        super("Grounded", cardStrings.NAME, null, 2, cardStrings.DESCRIPTION, CardType.POWER, CardColor.PURPLE,
                CardRarity.RARE, CardTarget.SELF);
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new DEPRECATEDGroundedPower((AbstractCreature) p)));
    }
 ...
 * DEPRECATEDGrounded.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
