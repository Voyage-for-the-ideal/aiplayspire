...
public class DEPRECATEDCondense extends AbstractCard {
    ...
    public DEPRECATEDCondense() {
        super("Condense", cardStrings.NAME, null, 2, cardStrings.DESCRIPTION, CardType.POWER, CardColor.PURPLE,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new DEPRECATEDCondensePower((AbstractCreature) p, this.magicNumber)));
    }
 ...
 * DEPRECATEDCondense.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
