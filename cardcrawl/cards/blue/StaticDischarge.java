...
public class StaticDischarge extends AbstractCard {
    ...
    public StaticDischarge() {
        super("Static Discharge", cardStrings.NAME, "blue/power/static_discharge", 1, cardStrings.DESCRIPTION,
                CardType.POWER, CardColor.BLUE, CardRarity.UNCOMMON, CardTarget.SELF);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new StaticDischargePower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
 ...
 * StaticDischarge.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
