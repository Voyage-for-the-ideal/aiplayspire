...
public class Heatsinks extends AbstractCard {
    ...
    public Heatsinks() {
        super("Heatsinks", cardStrings.NAME, "blue/power/heatsinks", 1, cardStrings.DESCRIPTION, CardType.POWER,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new HeatsinkPower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
 ...
 * Heatsinks.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
