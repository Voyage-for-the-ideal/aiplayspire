...
public class Reaper extends AbstractCard {
    ...
    public Reaper() {
        super("Reaper", cardStrings.NAME, "red/attack/reaper", 2, cardStrings.DESCRIPTION, CardType.ATTACK,
                CardColor.RED, CardRarity.RARE, CardTarget.ALL_ENEMY);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot((AbstractGameAction) new VampireDamageAllEnemiesAction((AbstractCreature) p, this.multiDamage,
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\cards\red\Reaper.
