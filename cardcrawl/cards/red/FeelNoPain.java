...
public class FeelNoPain extends AbstractCard {
    ...
    public FeelNoPain() {
        super("Feel No Pain", cardStrings.NAME, "red/power/feel_no_pain", 1, cardStrings.DESCRIPTION, CardType.POWER,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new FeelNoPainPower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
 ...
 * FeelNoPain.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
