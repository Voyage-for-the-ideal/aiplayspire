...
public class Defend_Red extends AbstractCard {
    ...
    public Defend_Red() {
        super("Defend_R", cardStrings.NAME, "red/skill/defend", 1, cardStrings.DESCRIPTION, CardType.SKILL,
                CardColor.RED, CardRarity.BASIC, CardTarget.SELF);
 ...
 * Defend_Red.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
