...
public class IronWave extends AbstractCard {
    ...
    public IronWave() {
        super("Iron Wave", cardStrings.NAME, "red/attack/iron_wave", 1, cardStrings.DESCRIPTION, CardType.ATTACK,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (p != null && m != null) {
            addToBot((AbstractGameAction) new VFXAction(
                    (AbstractGameEffect) new IronWaveEffect(p.hb.cX, p.hb.cY, m.hb.cX), 0.5F));
        }
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\cards\red\IronWave
