...
public class Rupture extends AbstractCard {
    ...
    public Rupture() {
        super("Rupture", cardStrings.NAME, "red/power/rupture", 1, cardStrings.DESCRIPTION, CardType.POWER,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new RupturePower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\cards\red\Rupture.
