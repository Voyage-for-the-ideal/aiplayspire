...
public class DualWield extends AbstractCard {
    ...
    public DualWield() {
        super("Dual Wield", cardStrings.NAME, "red/skill/dual_wield", 1, cardStrings.DESCRIPTION, CardType.SKILL,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new DualWieldAction((AbstractCreature) p, this.magicNumber));
    }
 ...
 * DualWield.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
