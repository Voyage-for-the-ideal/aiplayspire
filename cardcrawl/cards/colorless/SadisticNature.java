...
public class SadisticNature extends AbstractCard {
    ...
    public SadisticNature() {
        super("Sadistic Nature", cardStrings.NAME, "colorless/power/sadistic_nature", 0, cardStrings.DESCRIPTION,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new SadisticPower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
 ...
 * SadisticNature.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
