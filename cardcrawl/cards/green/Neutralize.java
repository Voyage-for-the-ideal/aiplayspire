...
public class Neutralize extends AbstractCard {
    ...
    public Neutralize() {
        super("Neutralize", cardStrings.NAME, "green/attack/neutralize", 0, cardStrings.DESCRIPTION, CardType.ATTACK,
                CardColor.GREEN, CardRarity.BASIC, CardTarget.ENEMY);
 ...
 * Neutralize.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
