...
public class PhantasmalKiller extends AbstractCard {
    ...
    public PhantasmalKiller() {
        super("Phantasmal Killer", cardStrings.NAME, "green/skill/phantasmal_killer", 1, cardStrings.DESCRIPTION,
                CardType.SKILL, CardColor.GREEN, CardRarity.RARE, CardTarget.SELF);
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new PhantasmalPower((AbstractCreature) p, 1), 1));
    }
 ...
 * PhantasmalKiller.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
