...
public class BulletTime extends AbstractCard {
    ...
    public BulletTime() {
        super("Bullet Time", cardStrings.NAME, "green/skill/bullet_time", 3, cardStrings.DESCRIPTION, CardType.SKILL,
                CardColor.GREEN, CardRarity.RARE, CardTarget.NONE);
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new NoDrawPower((AbstractCreature) p), 1));
 ...
 * BulletTime.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
