...
public class Nightmare extends AbstractCard {
    ...
    public Nightmare() {
        super("Night Terror", cardStrings.NAME, "green/skill/nightmare", 3, cardStrings.DESCRIPTION, CardType.SKILL,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(
                (AbstractGameAction) new NightmareAction((AbstractCreature) p, (AbstractCreature) p, this.magicNumber));
    }
 ...
 * Nightmare.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
