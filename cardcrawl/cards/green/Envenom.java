...
public class Envenom extends AbstractCard {
    ...
    public Envenom() {
        super("Envenom", cardStrings.NAME, "green/power/envenom", 2, cardStrings.DESCRIPTION, CardType.POWER,
                CardColor.GREEN, CardRarity.RARE, CardTarget.SELF);
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new EnvenomPower((AbstractCreature) p, 1), 1));
    }
 ...
 * Envenom.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
