...
public class AfterImage extends AbstractCard {
    ...
    public AfterImage() {
        super("After Image", cardStrings.NAME, "green/power/after_image", 1, cardStrings.DESCRIPTION, CardType.POWER,
                CardColor.GREEN, CardRarity.RARE, CardTarget.SELF);
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new AfterImagePower((AbstractCreature) p, 1), 1));
    }
 ...
 * AfterImage.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
