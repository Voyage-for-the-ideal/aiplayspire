...
public class Caltrops extends AbstractCard {
    ...
    public Caltrops() {
        super("Caltrops", cardStrings.NAME, "green/power/caltrops", 1, cardStrings.DESCRIPTION, CardType.POWER,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new ThornsPower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
 ...
 * Caltrops.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
