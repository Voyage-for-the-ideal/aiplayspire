...
public class Devotion extends AbstractCard {
    ...
    public Devotion() {
        super("Devotion", cardStrings.NAME, "purple/power/devotion", 1, cardStrings.DESCRIPTION, CardType.POWER,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new DevotionPower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
 ...
 * Devotion.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
