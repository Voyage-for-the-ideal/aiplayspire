...
public class Swivel extends AbstractCard {
    ...
    public Swivel() {
        super("Swivel", cardStrings.NAME, "purple/skill/swivel", 2, cardStrings.DESCRIPTION, CardType.SKILL,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new FreeAttackPower((AbstractCreature) p, 1), 1));
    }
 ...
 * Swivel.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
