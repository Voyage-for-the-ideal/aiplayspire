...
public class LiveForever extends AbstractCard {
    ...
    public LiveForever() {
        super("LiveForever", cardStrings.NAME, "colorless/power/live_forever", -2, cardStrings.DESCRIPTION,
    ...
    public void onChoseThisOption() {
        ...
        addToBot(
                (AbstractGameAction) new VFXAction((AbstractGameEffect) new BorderFlashEffect(Color.CHARTREUSE, true)));
        addToBot((AbstractGameAction) new VFXAction((AbstractCreature) p,
                (AbstractGameEffect) new MiracleEffect(Color.CHARTREUSE, Color.LIME, "BLOCK_GAIN_1"), 1.0F));
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) p, (AbstractCreature) p,
                (AbstractPower) new PlatedArmorPower((AbstractCreature) p, this.magicNumber), this.magicNumber));
    }
 ...
 * LiveForever.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
