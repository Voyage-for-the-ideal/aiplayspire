...
public class SSCallback
    ...
    public void onLeaderboardScoreUploaded(boolean success, SteamLeaderboardHandle handle, int score, boolean changed,
    ...
    public void onLeaderboardScoresDownloaded(SteamLeaderboardHandle handle, SteamLeaderboardEntriesHandle entries,
            int numEntries) {
        if (SteamIntegration.task == SteamIntegration.LeaderboardTask.RETRIEVE) {
            ...
            for (int i = 0; i < numEntries; i++) {
                ...
                if (SteamIntegration.steamStats.getDownloadedLeaderboardEntry(entries, i, entry, details)) {
                    ...
                    CardCrawlGame.mainMenuScreen.leaderboardsScreen.entries.add(new LeaderboardEntry(rTemp,
                            SteamIntegration.steamFriends

                                    .getFriendPersonaName(entry.getSteamIDUser()),
                            entry
                                    .getScore(),
                            SteamIntegration.gettingTime,
                            (SteamIntegration.accountId != -1 && SteamIntegration.accountId == entry
            ...
            for (int i = 0; i < numEntries; i++) {
                ...
                if (SteamIntegration.steamStats.getDownloadedLeaderboardEntry(entries, i, entry, details)) {
                    ...
                    CardCrawlGame.mainMenuScreen.dailyScreen.entries.add(new LeaderboardEntry(rTemp,
                            SteamIntegration.steamFriends
 ...
 * \SSCallback.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
