...
public class RarePotionParticleEffect extends AbstractGameEffect {
    ...
    public RarePotionParticleEffect(Hitbox hb) {
        ...
        this.oX += MathUtils.random(-27.0F, 27.0F) * Settings.scale;
        this.oY += MathUtils.random(-27.0F, 27.0F) * Settings.scale;
 ...
 * RarePotionParticleEffect.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
