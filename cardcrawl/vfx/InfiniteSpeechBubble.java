...
public class InfiniteSpeechBubble extends AbstractGameEffect {
    ...
    public InfiniteSpeechBubble(float x, float y, String msg) {
        this.textEffect = new SpeechTextEffect(x - 170.0F * Settings.scale, y + 124.0F * Settings.scale,
                Float.MAX_VALUE, msg, DialogWord.AppearEffect.BUMP_IN);
    ...
    private void updateScale() {
        ...
        if (Settings.isMobile) {
            this.scale_x = Interpolation.circleIn.apply(Settings.scale * 1.15F, Settings.scale * 0.5F,
                    this.scaleTimer / 0.3F);

            this.scale_y = Interpolation.swingIn.apply(Settings.scale * 1.15F, Settings.scale * 0.8F,
                    this.scaleTimer / 0.3F);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.SPEECH_BUBBLE_IMG, this.x - 256.0F + this.shadow_offset,
                this.y - 256.0F + this.wavy_y - this.shadow_offset, 256.0F, 256.0F, 512.0F, 512.0F, this.scale_x,
                this.scale_y, this.rotation, 0, 0, 512, 512, this.facingRight, false);

        sb.setColor(this.color);
        sb.draw(ImageMaster.SPEECH_BUBBLE_IMG, this.x - 256.0F, this.y - 256.0F + this.wavy_y, 256.0F, 256.0F, 512.0F,
                512.0F, this.scale_x, this.scale_y, this.rotation, 0, 0, 512, 512, this.facingRight, false);
    }
 ...
 * InfiniteSpeechBubble.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
