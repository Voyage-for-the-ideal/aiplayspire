...
public class GainPennyEffect extends AbstractGameEffect {
    ...
    public GainPennyEffect(AbstractCreature owner, float x, float y, float targetX, float targetY,
            boolean showGainEffect) {
    ...
    public GainPennyEffect(float x, float y) {
        this((AbstractCreature) AbstractDungeon.player, x, y, AbstractDungeon.player.hb.cX,
                AbstractDungeon.player.hb.cY, true);
    }
 ...
 * GainPennyEffect.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
