...
public class WrathStanceChangeParticle extends AbstractGameEffect {
    ...
    public WrathStanceChangeParticle(float playerX) {
        ...
        this.y = Settings.HEIGHT / 2.0F + MathUtils.random(-150.0F, 150.0F) * Settings.scale
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw((TextureRegion) this.img, AbstractDungeon.player.hb.cX + this.x, this.y, this.img.packedWidth / 2.0F,
                this.img.packedHeight / 2.0F, this.img.packedWidth, this.img.packedHeight, this.scale *

                        MathUtils.random(2.9F, 3.1F),
                this.scale *
 ...
 * WrathStanceChangeParticle.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
