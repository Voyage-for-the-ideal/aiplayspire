...
public class MegaDialogTextEffect
    ...
    private static final float DEFAULT_WIDTH = 320.0F * Settings.scale;
    private static final float LINE_SPACING = Settings.isMobile ? (33.0F * Settings.scale) : (30.0F * Settings.scale);
    ...
    private void addWord() {
        ...
        if (this.s.hasNext()) {
            ...
            this.words.add(new SpeechWord(this.font, word, this.a_effect, effect, color, this.x + temp,
                    this.y - LINE_SPACING * this.curLine, this.curLine));
        } else {
    ...
    private void addWordCN() {
        ...
        if (this.s.hasNext()) {
            ...
            for (int i = 0; i < word.length(); i++) {
                ...
                this.words.add(new SpeechWord(this.font, tmp, this.a_effect, effect, color, this.x + temp,
                        this.y - LINE_SPACING * this.curLine, this.curLine));
            }
        } else {
 ...
 * MegaDialogTextEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
