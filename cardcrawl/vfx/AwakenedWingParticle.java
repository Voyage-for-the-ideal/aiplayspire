...
public class AwakenedWingParticle
    ...
    private TextureAtlas.AtlasRegion img = ImageMaster.THICK_3D_LINE_2;
    ...
    public AwakenedWingParticle() {
        ...
        this.x -= (this.img.packedWidth / 2);
        this.y -= (this.img.packedHeight / 2);
    }
    ...
    public void render(SpriteBatch sb, float x, float y) {
        ...
        sb.draw((TextureRegion) this.img, this.x + x, this.y + y, this.img.packedWidth * 0.08F,
                this.img.packedHeight / 2.0F, this.img.packedWidth, this.img.packedHeight, this.scale *

                        MathUtils.random(1.1F, 1.25F),
                this.scale, this.rotation + derp);
        ...
        sb.draw((TextureRegion) this.img, this.x + x, this.y + y, this.img.packedWidth * 0.08F,
                this.img.packedHeight / 2.0F, this.img.packedWidth, this.img.packedHeight, this.scale * 0.7F,
                this.scale * 0.7F, this.rotation + derp - 40.0F);
    }
 ...
 * AwakenedWingParticle.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
