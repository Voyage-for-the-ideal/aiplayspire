...
public class FlameParticleEffect extends AbstractGameEffect {
    ...
    public void update() {
        ...
        if (this.duration < 0.0F) {
            ...
            this.color.a = Interpolation.fade.apply(0.0F, 0.5F,
                    (this.startingDuration - this.duration) / this.startingDuration / 2.0F);
        } else if (this.duration < this.startingDuration / 2.0F) {
 ...
 * FlameParticleEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
