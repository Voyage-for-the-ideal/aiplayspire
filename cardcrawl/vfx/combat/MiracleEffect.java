...
public class MiracleEffect
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw((TextureRegion) this.img, this.x, this.y, this.img.packedWidth / 2.0F, this.img.packedHeight / 2.0F,
                this.img.packedWidth, this.img.packedHeight, this.scale * 1.1F, this.scale * 1.1F, 0.0F);

        sb.setColor(this.color);
        sb.draw((TextureRegion) this.img, this.x, this.y, this.img.packedWidth / 2.0F, this.img.packedHeight / 2.0F,
                this.img.packedWidth, this.img.packedHeight, this.scale * 0.9F, this.scale * 0.9F, 0.0F);
 ...
 * MiracleEffect.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
