...
public class ThrowDaggerEffect
    ...
    public void render(SpriteBatch sb) {
        ...
        if (!this.forcedAngle) {
            sb.draw((TextureRegion) this.img, this.x, this.y, this.img.packedWidth * 0.85F,
                    this.img.packedHeight / 2.0F, this.img.packedWidth, this.img.packedHeight, this.scale,
                    this.scale * 1.5F, this.rotation);

            sb.setBlendFunction(770, 1);
            sb.draw((TextureRegion) this.img, this.x, this.y, this.img.packedWidth * 0.85F,
                    this.img.packedHeight / 2.0F, this.img.packedWidth, this.img.packedHeight, this.scale * 0.75F,
                    this.scale * 0.75F, this.rotation);
 ...
 * ThrowDaggerEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
