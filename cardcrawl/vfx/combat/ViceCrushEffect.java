...
public class ViceCrushEffect extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw((TextureRegion) img, this.x, this.y, img.packedWidth / 2.0F, img.packedHeight / 2.0F, img.packedWidth,
                img.packedHeight, this.scale * this.scale * Settings.scale * 0.5F,
                this.scale * Settings.scale * (this.duration + 0.8F), this.rotation);

        sb.draw((TextureRegion) img, this.x2, this.y, img.packedWidth / 2.0F, img.packedHeight / 2.0F, img.packedWidth,
                img.packedHeight, this.scale * this.scale * Settings.scale * 0.5F,
                this.scale * Settings.scale * (this.duration + 0.8F), this.rotation - 180.0F);

        sb.setColor(new Color(0.7F, 0.5F, 0.9F, this.color.a));
        sb.draw((TextureRegion) img, this.x, this.y, img.packedWidth / 2.0F, img.packedHeight / 2.0F, img.packedWidth,
                img.packedHeight, this.scale * this.scale * Settings.scale * 0.75F,
                this.scale * Settings.scale * (this.duration + 0.8F), this.rotation);
        ...
        sb.draw((TextureRegion) img, this.x, this.y, img.packedWidth / 2.0F, img.packedHeight / 2.0F, img.packedWidth,
                img.packedHeight, this.scale * this.scale * Settings.scale,
                this.scale * Settings.scale * (this.duration + 1.0F), this.rotation);

        sb.draw((TextureRegion) img, this.x2, this.y, img.packedWidth / 2.0F, img.packedHeight / 2.0F, img.packedWidth,
                img.packedHeight, this.scale * this.scale * Settings.scale,
                this.scale * Settings.scale * (this.duration + 1.0F), this.rotation - 180.0F);
 ...
 * ViceCrushEffect.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
