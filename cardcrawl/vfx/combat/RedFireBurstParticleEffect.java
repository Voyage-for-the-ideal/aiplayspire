...
public class RedFireBurstParticleEffect extends AbstractGameEffect {
    ...
    public RedFireBurstParticleEffect(float x, float y, int timesUpgraded) {
        ...
        this.y = y - (this.img.packedHeight / 2) + MathUtils.random(-20.0F, 20.0F) * Settings.scale;
        this

                .color = new Color(MathUtils.random(0.8F, 1.0F), MathUtils.random(0.3F, 0.8F),
 ...
 * RedFireBurstParticleEffect.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
