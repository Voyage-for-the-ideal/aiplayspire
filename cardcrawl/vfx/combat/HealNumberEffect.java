...
public class HealNumberEffect extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderFontCentered(sb, FontHelper.damageNumberFont, Integer.toString(this.number), this.x, this.y,
                this.color);
    }
 ...
 * HealNumberEffect.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
