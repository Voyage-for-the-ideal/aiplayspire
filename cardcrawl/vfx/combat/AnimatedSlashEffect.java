...
public class AnimatedSlashEffect
    ...
    public void update() {
        if (this.duration > this.startingDuration / 2.0F) {
            this.color.a = Interpolation.exp10In.apply(0.8F, 0.0F,
                    (this.duration - this.startingDuration / 2.0F) / this.startingDuration / 2.0F);

            this.scaleX = Interpolation.exp10In.apply(this.targetScale, 0.1F,
                    (this.duration - this.startingDuration / 2.0F) / this.startingDuration / 2.0F);

            this.scaleY = this.scaleX;
            this.x = Interpolation.fade.apply(this.tX, this.sX,
                    (this.duration - this.startingDuration / 2.0F) / this.startingDuration / 2.0F);
            this.y = Interpolation.fade.apply(this.tY, this.sY,
                    (this.duration - this.startingDuration / 2.0F) / this.startingDuration / 2.0F);
        } else {
            this.scaleX = Interpolation.pow2In.apply(0.5F, this.targetScale,
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.ANIMATED_SLASH_VFX, this.x, this.y, 64.0F, 64.0F, 128.0F, 128.0F, this.scaleX * 0.4F *

                MathUtils.random(0.95F, 1.05F) * Settings.scale,
                this.scaleY * 0.7F *
                        MathUtils.random(0.95F, 1.05F) * Settings.scale,
                this.rotation, 0, 0, 128, 128, false, false);

        sb.setColor(this.color);
        sb.draw(ImageMaster.ANIMATED_SLASH_VFX, this.x, this.y, 64.0F, 64.0F, 128.0F, 128.0F, this.scaleX * 0.7F *
 ...
 * AnimatedSlashEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
