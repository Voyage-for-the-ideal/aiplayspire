    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw((TextureRegion) this.img, this.x, this.y, this.img.packedWidth / 2.0F, this.img.packedHeight / 2.0F,
                this.img.packedWidth, this.img.packedHeight, (this.scale +
                        ...
                        MathUtils.random(-0.08F, 0.08F)) * Settings.scale,
                (this.scale + this.scaleXMod +
                        MathUtils.random(-0.08F, 0.08F)) * Settings.scale,
                this.rotation + this.flipper +
 ...
 * LightRayFlyOutEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
