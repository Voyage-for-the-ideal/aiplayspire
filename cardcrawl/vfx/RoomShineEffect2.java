...
public class RoomShineEffect2 extends AbstractGameEffect {
    ...
    public RoomShineEffect2() {
        ...
        this.y = MathUtils.random(Settings.HEIGHT * 0.0F, Settings.HEIGHT * 0.9F) - this.img.packedHeight / 2.0F;
        ...
        this.scale = 0.01F;
        this.targetScale = MathUtils.random(1.0F, 1.5F);
 ...
 * RoomShineEffect2.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
