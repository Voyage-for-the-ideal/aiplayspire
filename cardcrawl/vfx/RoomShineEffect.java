...
public class RoomShineEffect extends AbstractGameEffect {
    ...
    public RoomShineEffect() {
        this.effectDuration = MathUtils.random(2.0F, 3.0F);
        this.duration = this.effectDuration;
        this.startingDuration = this.effectDuration;
        this.x = MathUtils.random(50.0F, 1870.0F) * Settings.scale - this.img.packedWidth / 2.0F;
        this.y = MathUtils.random(Settings.HEIGHT * 0.1F, Settings.HEIGHT * 0.85F) - this.img.packedHeight / 2.0F;
 ...
 * RoomShineEffect.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
