...
public class UpgradeShineParticleEffect extends AbstractGameEffect {
    ...
    public UpgradeShineParticleEffect(float x, float y) {
        ...
        this
                ...
                .color = new Color(MathUtils.random(0.5F, 1.0F), MathUtils.random(0.4F, 0.6F),
                        MathUtils.random(0.0F, 0.2F), 0.0F);
 ...
 * UpgradeShineParticleEffect.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
