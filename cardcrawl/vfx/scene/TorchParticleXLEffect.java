    ...
    public TorchParticleXLEffect(float x, float y, float scaleMultiplier) {
        ...
        if (!renderGreen) {
            this
                    ...
                    .color = new Color(MathUtils.random(0.6F, 1.0F), MathUtils.random(0.3F, 0.6F),
                            MathUtils.random(0.0F, 0.3F), 0.01F);
        } else {
 ...
 * TorchParticleXLEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
