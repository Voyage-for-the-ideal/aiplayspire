...
public class LightFlareLEffect extends AbstractGameEffect {
    ...
    public LightFlareLEffect(float x, float y) {
        ...
        this.scale = Settings.scale * MathUtils.random(6.0F, 7.0F);
        this.rotation = MathUtils.random(360.0F);

        if (!renderGreen) {
            this

                    .color = new Color(MathUtils.random(0.6F, 1.0F), MathUtils.random(0.4F, 0.7F),
                            MathUtils.random(0.2F, 0.3F), 0.01F);
        } else {

            this

                    .color = new Color(MathUtils.random(0.1F, 0.3F), MathUtils.random(0.5F, 0.9F),
                            MathUtils.random(0.1F, 0.3F), 0.01F);
        }
 ...
 * LightFlareLEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
