...
public class SpeechBubble extends AbstractGameEffect {
    ...
    public SpeechBubble(float x, float y, float duration, String msg, boolean isPlayer) {
        ...
        AbstractDungeon.effectsQueue.add(new SpeechTextEffect(x + effect_x, y + 124.0F * Settings.scale, duration, msg,
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\vfx\SpeechBubble.
