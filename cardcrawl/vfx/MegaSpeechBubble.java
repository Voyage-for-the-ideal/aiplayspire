...
public class MegaSpeechBubble extends AbstractGameEffect {
    ...
    public MegaSpeechBubble(float x, float y, float duration, String msg, boolean isPlayer) {
        ...
        AbstractDungeon.effectsQueue.add(new MegaDialogTextEffect(x + effect_x, y + 124.0F * Settings.scale, duration,
                msg, DialogWord.AppearEffect.BUMP_IN));
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(ImageMaster.SPEECH_BUBBLE_IMG, this.x - 256.0F + this.shadow_offset,
                this.y - 256.0F - this.shadow_offset + this.wavy_y, 256.0F, 256.0F, 512.0F, 512.0F, this.scale_x,
 ...
 * MegaSpeechBubble.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
