...
public class FlameAnimationEffect extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb, float s) {
        ...
        if (this.img != null)
            sb.draw(this.img, this.nodeHb.cX - 128.0F + this.offsetX, this.nodeHb.cY - 128.0F + this.offsetY, 128.0F,
                    128.0F, 256.0F, 256.0F, s * this.scale, s * this.scale, this.rotation, 0, 0, 256, 256, this.flipped,
                    false);
    }
 ...
 * FlameAnimationEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
