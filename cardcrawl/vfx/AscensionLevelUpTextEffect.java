...
public class AscensionLevelUpTextEffect extends AbstractGameEffect {
    ...
    private static final float START_Y = Settings.HEIGHT / 2.0F + 130.0F * Settings.scale;
    private static final float TARGET_Y = Settings.HEIGHT / 2.0F + 230.0F * Settings.scale;
    private float y;
    private int level;
    ...
    public void render(SpriteBatch sb) {
        FontHelper.renderFontCentered(sb, FontHelper.buttonLabelFont, TEXT[0] + this.level + TEXT[1],
                Settings.WIDTH / 2.0F, this.y, this.color);
    }
 ...
 * AscensionLevelUpTextEffect.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
