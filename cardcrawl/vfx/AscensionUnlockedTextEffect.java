...
public class AscensionUnlockedTextEffect extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb) {
        FontHelper.renderFontCentered(sb, FontHelper.buttonLabelFont, uiStrings.TEXT[0], Settings.WIDTH / 2.0F, this.y,
                this.color);
    }
 ...
 * AscensionUnlockedTextEffect.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
