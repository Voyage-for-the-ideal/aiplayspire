...
public class RelicAboveCreatureEffect
    ...
    public void update() {
        ...
        if (AbstractDungeon.player.chosenClass == AbstractPlayer.PlayerClass.DEFECT) {
            this.offsetY = MathUtils.lerp(this.offsetY, TARGET_OFFSET_Y + 80.0F * Settings.scale, Gdx.graphics
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.relic.outlineImg, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F,
                this.scale * (2.5F - this.duration), this.scale * (2.5F - this.duration), this.rotation, 0, 0, 128, 128,
                false, false);

        sb.setColor(this.color);
        sb.draw(this.relic.img, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F,
                this.scale * (2.5F - this.duration), this.scale * (2.5F - this.duration), this.rotation, 0, 0, 128, 128,
                false, false);
        ...
        sb.draw(this.relic.img, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F,
                this.scale * (2.7F - this.duration), this.scale * (2.7F - this.duration), this.rotation, 0, 0, 128, 128,
                false, false);

        sb.draw(this.relic.img, this.x - 64.0F, this.y - 64.0F + this.offsetY, 64.0F, 64.0F, 128.0F, 128.0F,
                this.scale * (3.0F - this.duration), this.scale * (3.0F - this.duration), this.rotation, 0, 0, 128, 128,
                false, false);
 ...
 * RelicAboveCreatureEffect.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
