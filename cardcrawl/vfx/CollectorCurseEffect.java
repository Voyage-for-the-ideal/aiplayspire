...
public class CollectorCurseEffect
    ...
    public void update() {
        ...
        if (this.stakeTimer < 0.0F) {
            ...
            AbstractDungeon.effectsQueue.add(new CollectorStakeEffect(this.x +

                    MathUtils.random(-50.0F, 50.0F) * Settings.scale,
                    this.y +
                            MathUtils.random(-60.0F, 60.0F) * Settings.scale));
 ...
 * CollectorCurseEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
