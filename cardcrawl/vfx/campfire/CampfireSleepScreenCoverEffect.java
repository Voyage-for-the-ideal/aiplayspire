...
public class CampfireSleepScreenCoverEffect extends AbstractGameEffect {
    ...
    public CampfireSleepScreenCoverEffect() {
        ...
        this.x = MathUtils.random(-100.0F * Settings.scale, Settings.WIDTH + 100.0F * Settings.scale)
                - this.img.packedWidth / 2.0F;
        this.y = MathUtils.random(-100.0F * Settings.scale, Settings.HEIGHT + 100.0F * Settings.scale)
 ...
 * CampfireSleepScreenCoverEffect.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */
