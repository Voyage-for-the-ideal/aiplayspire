...
public class CampfireSleepEffect
    ...
    private void updateBlackScreenColor() {
        if (this.duration > this.startingDuration - 0.5F) {
            this.screenColor.a = Interpolation.fade.apply(1.0F, 0.0F,
                    (this.duration - this.startingDuration - 0.5F) * 2.0F);
 ...
 * CampfireSleepEffect.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */
