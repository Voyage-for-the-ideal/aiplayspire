...
public class BlockReturnPower extends AbstractPower {
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        if (info.type != DamageInfo.DamageType.THORNS && info.type != DamageInfo.DamageType.HP_LOSS
            ...
            flash();
            addToTop((AbstractGameAction) new GainBlockAction((AbstractCreature) AbstractDungeon.player, this.amount,
                    Settings.FAST_MODE));
        }
        return damageAmount;
    }
 ...
 * BlockReturnPower.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */
