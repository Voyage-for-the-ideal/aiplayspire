...
public class FlightPower
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        Boolean willLive = Boolean
                .valueOf((calculateDamageTakenAmount(damageAmount, info.type) < this.owner.currentHealth));
        if (info.owner != null && info.type != DamageInfo.DamageType.HP_LOSS
                && info.type != DamageInfo.DamageType.THORNS && damageAmount > 0 && willLive
                        .booleanValue()) {
            flash();
            addToBot((AbstractGameAction) new ReducePowerAction(this.owner, this.owner, "Flight", 1));
        }
        return damageAmount;
    }
...
/*
 * Location:
 * E:\代码\SlayTheSpire\desktop-1.0.jar!\com\megacrit\cardcrawl\powers\FlightPower
