...
public class SaveFile {
    ...
    /*
     * loaded from:
     * desktop-1.0.jar:com/megacrit/cardcrawl/saveAndContinue/SaveFile$SaveType.
     * class
     */
    ...
    public SaveFile(SaveType type) {
        ...
        if (!AbstractDungeon.player.hasRelic(BottledLightning.ID)) {
            ...
            this.bottled_lightning = ((BottledLightning) AbstractDungeon.player
                    .getRelic(BottledLightning.ID)).card.cardID;
        } else {
            this.bottled_lightning = null;
        }
